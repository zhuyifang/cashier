<template>
  <q-layout view="lHh lpR fFf">
    <q-header bordered class="fixed bg-grey-10" style="right:0;left: 81px">
      <q-bar dark>
        <span class="text-grey-4">{{ $store.state.mall.name }}</span>
        <q-space/>
    ...
    <q-drawer :width="80" bordered no-swipe-close :model-value="true" show-if-above side="left" dark>
    ...
    <q-page-container class="page-main">
      <router-view/>
    </q-page-container>
  </q-layout>
</template>
