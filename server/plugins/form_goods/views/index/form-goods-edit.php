...
<script>
    ...
    const _appImg = _currentPluginBaseUrl + '/images/';
</script>
                ...
                <div class="all-components">
                    <el-form @submit.native.prevent label-width="95px" ref="templateName">
                        <el-form-item :rules="[{ required: true, validator: validate, trigger: 'change'}]"
                                      label="模板名称"
                                      prop="templateName">
                            <el-input style="width: 190px" size="small" placeholder="请输入名称" show-word-limit v-model="templateName" maxlength="15"></el-input>
                        </el-form-item>
                    </el-form>
