        ...
        try {
            ...
            foreach ($bargainOrderList as $bargainOrder) {
                ...
                $newItem = [
                    ...
                    'price' => price_format($bargainOrder->price),
                    'min_price' => price_format($bargainOrder->min_price),
                    'now_price' => price_format($nowPrice),
                    'reset_price' => price_format($resetPrice),
