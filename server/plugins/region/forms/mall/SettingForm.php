...
class SettingForm extends Model
{
    ...
    public function search()
    {
        ...
        $list = CashPayType::change($list, RegionSetting::PAY_TYPE);
        ...
        if (!\Yii::$app->user->isGuest) {
            $cashList = RegionCash::find()->alias('a')->select('a.type,a.extra,a.use_qrcode')
                ->where([
            ...
            foreach ($cashList as $item) {
                ...
                $list['last_cash_list'][$item['type']] = $item;
            }
        }
