...
class OrderCancelForm extends Model
{
    ...
    public function save()
    {
        ...
        try {
            ...
            $pintuanOrderRelation = PintuanOrderRelation::find()->with('pintuanOrder.orderRelation')->andWhere(['order_id' => $order->id, 'is_delete' => 0])->one();
            ...
            $orderIds = [];
            foreach ($pintuanOrderRelation->pintuanOrder->orderRelation as $item) {
