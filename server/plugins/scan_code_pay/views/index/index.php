...
<div id="app" v-cloak>
    <el-card v-loading="loading" style="border:0" shadow="never" body-style="background-color: #f3f3f3;padding: 0 0;">
            ...
            <el-tabs v-model="activeName">
                <el-tab-pane label="基础配置" name="first">
                    <div class="form-body">
                        ...
                        <el-form-item label="付款按钮文字自定义" prop="btn_text">
                            <el-input style="width: 50%;" size="small" placeholder="请输入按钮文案，例：已与店员确认，立即买单" maxlength="15" show-word-limit v-model="form.btn_text"></el-input>
                            <div>
                                <el-button @click="imageDialog = true" type="text">查看图例</el-button>
                            </div>
                        </el-form-item>
        ...
        <el-dialog title="付款按钮文案自定义图例" :visible.sync="imageDialog" width="30%">
        <div style="padding-top: 10px;" flex="main:center">
            <img style="width: 375px;" :src="form.cover_pic" alt="">
        </div>
        <span slot="footer" class="dialog-footer">
            <el-button size="small" type="primary" @click="imageDialog = false">我知道了</el-button>
        </span>
    </el-dialog>
    </el-card>
</div>
    ...
    const app = new Vue({
        ...
        data() {
            return {
                ...
                rule: {
                    btn_text: [
                        {required: true, message: '请输入按钮提示文字', trigger: 'change'},
                    ],
                },
                components: [
                    {
