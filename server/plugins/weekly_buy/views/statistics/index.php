...
<div id="app" v-cloak>
    <el-card shadow="never" style="border:0" body-style="background-color: #f3f3f3;padding: 10px 0 0;">
        <div slot="header">
            <app-header :url="url" :new-search="JSON.stringify(search)">周期购</app-header>
        </div>
...
<!--                 <el-table-column prop="attr" label="规格">
                ...
                <el-table-column prop="week_number" label="支付期数" :label-class-name="prop == 'week_number' ? 'sort-active': ''" sortable='custom'>
                </el-table-column>
            </el-table>
...
<script>
    const app = new Vue({
        ...
        data() {
            return {
                url: 'plugin/weekly_buy/mall/statistics/index',
                loading: false,
                // 今天
                today: '',
                // 七天前
        ...
        methods: {
            ...
            getList() {
                ...
                request({
                    params: {
                        r: 'plugin/weekly_buy/mall/statistics/index',
