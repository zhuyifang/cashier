 ...
 * @property int $is_trigger 开奖是否限制
 * @property string $trigger_type 开奖限制方式
 * @property int $people_min_num 满人开奖
...
class Lottery extends ModelActiveRecord
{
    ...
    {
        return [
            [['mall_id', 'goods_id', 'buy_goods_id'], 'required'],
            [['mall_id', 'goods_id', 'status', 'type', 'stock', 'join_min_num', 'sort', 'is_delete', 'participant', 'invitee', 'code_num', 'buy_goods_id', 'deplete_integral_num', 'is_trigger', 'people_min_num'], 'integer'],
            [['start_at', 'end_at', 'created_at', 'updated_at', 'deleted_at', 'open_at'], 'safe'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'goods_id' => '规格',
            'status' => '0关闭 1开启',
            'type' => '0未完成 1已完成 2超限 3过期',
            'stock' => '库存',
            'start_at' => '开始时间',
            'end_at' => '结束时间',
            'join_min_num' => '参加最少人数限制',
            'sort' => '排序',
            'is_delete' => '删除',
