                ...
                <el-card shadow="never" class="mt-24">
                    ...
                    <el-row>
                        <el-col :xl="12" :lg="16">
                            ...
                            <el-form-item label="开奖人数设置">
                                <el-switch v-model="form.is_trigger" :active-value="1" :inactive-value="0"></el-switch>
                                <div flex="dir:top" v-if="form.is_trigger == 1">
                                    <div flex="dir:left cross:center">
                                        <app-radio v-model="form.trigger_type" label="people" trun></app-radio>
                                        <div style="margin-left: -32px;margin-right: 10px">人数满</div>
                                        <el-input v-model="form.people_min_num" style="width: 200px" size="small">
                                            <template slot="append">人</template>
                                        </el-input>
                                        <div style="margin-left: 10px">立即开奖</div>
                                    </div>
                                    <div flex="dir:left cross:center" style="margin-top: 10px">
                                        <app-radio v-model="form.trigger_type" label="time" trun></app-radio>
                                        <div style="margin-left: -32px;margin-right: 10px">人数满</div>
                                        <el-input v-model="form.join_min_num" style="width: 200px" size="small">
                                            <template slot="append">人</template>
                                        </el-input>
                                        <div style="margin-left: 10px">活动时间结束开奖</div>
                                    </div>
                                </div>
                            </el-form-item>
                            <el-form-item prop="join_min_num" v-if="false">
                                <template slot='label'>
                                    <span>开奖最低限制</span>
