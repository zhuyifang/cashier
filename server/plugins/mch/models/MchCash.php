...
class MchCash extends \app\models\ModelActiveRecord
{
    ...
    {
        return [
            [['mall_id', 'mch_id', 'money', 'created_at', 'updated_at', 'deleted_at', 'type', 'type_data'], 'required'],
            [['mall_id', 'mch_id', 'status', 'virtual_type', 'is_delete', 'transfer_status', 'use_qrcode'], 'integer'],
            [['money'], 'number'],
            [['type', 'content'], 'string'],
