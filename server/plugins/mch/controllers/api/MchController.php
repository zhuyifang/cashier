...
use app\plugins\mch\forms\api\SelfPosterForm;
...
class MchController extends ApiController
{
    ...
    public function actionSelfPoster()
    {
        $form = new SelfPosterForm();
        $form->attributes = \Yii::$app->request->get();
        return $this->asJson($form->config());
    }

    public function actionSelfSavePoster(){
        $form = new SelfPosterForm();
        $form->attributes = \Yii::$app->request->get();
        return $this->asJson($form->getPoster());
    }
}
