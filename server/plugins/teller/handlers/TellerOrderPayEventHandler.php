    ...
    private function pushOrder($order)
    {
        ...
        try {
            ...
            if ($tellerOrder->cashier) {
                ...
                $pushOrder->push_order_money = $setting['is_cashier_push'] ? $setting['cashier_push'] : 0;
                $pushOrder->push_percent = $setting['is_cashier_push'] ? $setting['cashier_push_percent'] : 0;
            ...
            if ($tellerOrder->sales) {
                ...
                $pushOrder->push_order_money = $setting['is_sales_push'] ? $setting['sales_push'] : 0;
                $pushOrder->push_percent = $setting['is_sales_push'] ? $setting['sales_push_percent'] : 0;
