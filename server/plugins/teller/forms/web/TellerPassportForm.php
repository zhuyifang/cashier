...
class TellerPassportForm extends Model
{
    ...
    public function login()
    {
        ...
        try {
            ...
            $userId = User::find()->andWhere(['username' => $this->username, 'mall_id' => $this->mall_id, 'is_delete' => 0])->select('id');
            ...
            return [
                ...
                'data' => [
                    'user' => [
                        ...
                        'id' => $cashier->user->id,
                        'access_token' => $cashier->user->access_token,
                    ],
