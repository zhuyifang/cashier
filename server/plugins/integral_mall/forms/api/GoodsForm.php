...
class GoodsForm extends Model
{
    ...
    public function getList()
    {
        ...
        foreach ($list as &$item) {
            ...
            $integralMallGoods->attributes = $item['integralMallGoods'];
            $minPriceAndIntegral = $commonGoods->findMinIntegral($integralMallGoods);
            $item['integralMallGoods']['integral_num'] = $minPriceAndIntegral['integral'];
            $item['price'] = $minPriceAndIntegral['price'];
    ...
    public function detail()
    {
        try {
            ...
            $minPriceAndIntegral = CommonGoods::getCommon()->findMinIntegral($integralMallGoods);
            $integralMallGoods->integral_num = $minPriceAndIntegral['integral'];
            $goods['price'] = $minPriceAndIntegral['price'];
