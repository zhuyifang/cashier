...
//            unlink($path);
    ...
    private function picKey()
    {
        return [
            ...
            'renew_bg', 'closedPicUrl', 'openedPicUrl', 'img', 'pay_update_icon'
        ];
    }
    ...
    public function unsetList($list)
    {
        ...
        foreach ($list as &$item) {
            ...
            if (isset($item['id']) && $item['id'] == 'form-module') {
                if (isset($item['data']['list'])) {
                    foreach ($item['data']['list'] as &$datum) {
                        if ($datum['id'] == 'menu' && $datum['data']['type'] == 'store') {
                            $datum['data']['type_data']['store'] = [];
                        }
                    }
                    unset($datum);
                }
                if (isset($item['data']['form_info']['form_data'])) {
                    foreach ($item['data']['form_info']['form_data'] as &$form_datum) {
                        if ($form_datum['id'] == 'menu' && $form_datum['data']['type'] == 'store') {
                            $form_datum['data']['type_data']['store'] = [];
                        }
                    }
                    unset($form_datum);
                }
