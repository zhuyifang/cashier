                                ...
                                <div :class="{active: hasNavShow}" class="app-nav-bar">
                                    <div class="diy-component-edit">
                                        <el-form label-width="100px">
                                            ...
                                            <el-form @submit.native.prevent label-width="110px" style="padding: 20px 0" :ref="templateName">
                                                <el-form-item
                                            ...
                                            <el-form-item label="选择风格" prop="style">
                                                <app-radio turn v-model="appNavBar.style" label="1">风格1</app-radio>
                                                <app-radio turn v-model="appNavBar.style" label="2">风格2</app-radio>
                                                <app-radio turn v-model="appNavBar.style" label="3">风格3</app-radio>
                                                <app-radio turn v-model="appNavBar.style" label="4">风格4</app-radio>
                                            </el-form-item>

                                            <el-form-item v-if="appNavBar.style == 1" label="展示位置" prop="position">
                                                <app-radio turn v-model="appNavBar.position" label="center">居中</app-radio>
                                                <app-radio turn v-model="appNavBar.position" label="left">左对齐</app-radio>
                                            </el-form-item>
                                            ...
                                            <el-form-item label="使用商城配置" label-width="110px" prop="hasMallSetting">
                                            ...
                                            <template v-if="!appNavBar.hasMallSetting">
                                                <el-form-item label-width="110px" v-if="[1,2,4].indexOf(Number(appNavBar.style)) !== -1"
                                                              label="文字颜色" prop="color">
                                                    <app-radio turn v-model="appNavBar.color" label="white">白色</app-radio>
                                                    <app-radio turn v-model="appNavBar.color" label="black">黑色</app-radio>
                                                </el-form-item>
                                                <el-form-item label-width="110px" label="背景颜色" prop="backgroundColor">
                                                    <el-color-picker size="small"
