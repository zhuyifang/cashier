            ...
            <el-form label-width="100px" @submit.native.prevent>
                ...
                <el-form-item label="填充颜色">
                    <div class="input-color" flex="dir:left cross:center">
                        ...
                        <el-input size="small" style="width: 64px;" v-model="data.inputBorder"></el-input>
                    </div>
                ...
                <el-form-item label="名称颜色">
                    <div class="input-color" flex="dir:left cross:center">
                        ...
                        <el-input size="small" style="width: 64px;" v-model="data.inputTip"></el-input>
                    </div>
                </el-form-item>
                ...
                <el-form-item label="填充颜色">
                    <div class="input-color" flex="dir:left cross:center">
                        ...
                        <el-input size="small" style="width: 64px;" v-model="data.borderBorder"></el-input>
                    </div>
                    <div style="color: #909399;margin-left: 212px">不填默认无边框</div>
                </el-form-item>
                <el-form-item label="文本颜色">
                ...
                <el-form-item label="外边距颜色">
                    <div class="input-color" flex="dir:left cross:center">
                        ...
                        <el-input size="small" style="width: 64px;margin-right: 25px;" v-model="data.marginColor"></el-input>
                    </div>
                </el-form-item>
