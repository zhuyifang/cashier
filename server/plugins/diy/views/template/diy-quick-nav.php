            ...
            <el-form label-width="100px" @submit.native.prevent style="padding: 20px 0">
                ...
                <template v-if="!data.useMallConfig && data.navSwitch == 1">
                    ...
                    <el-form-item label="导航样式">
                        <app-radio turn v-model="data.navStyle" :label="1">样式1(点击收起)</app-radio>
                        <app-radio turn v-model="data.navStyle" :label="2">样式2(全部展示)</app-radio>
                    </el-form-item>
...
<!--                                      v-model="data.customize.link_url" autocomplete="off">-->
                                <app-pick-link @selected="selectQuickCustomize" :show-customer="false" :link="data.customize.link ? data.customize.link : {url: data.customize.link_url}">
        ...
        methods: {
            ...
            selectQuickCustomize(e) {
                e.map(item => {
                    ...
                    Vue.set(this.data.customize, 'link', item);
                });
            },
            mapEvent(e) {
