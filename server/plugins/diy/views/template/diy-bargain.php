...
<style>
    ...
    .diy-bargain .scroll.list-one {
        position: absolute;
        height: 100%;
        width: 340px;
        right: 10px;
    }
    .diy-bargain .scroll .list-time {
        font-size: 24px;
        margin: 0 3px;
                ...
                <template slot="picEnd">
                    <div :style="cTimerStyle" :flex="cTimerFlex" class="goods-bargain-timer"
                        ...
                        <div v-if="data.listStyle===1">
                            <img src="statics/img/app/diy/bargain.png" style="width: 100%;height: 100%;" alt="">
                        </div>
        ...
        <div class="diy-component-edit">
            ...
            <el-form label-width="150px" @submit.native.prevent style="padding: 20px 0">
                ...
                <el-form-item label="商品角标样式" v-if="data.showGoodsTag">
                    <app-radio turn v-model="data.goodsTagPicUrl" v-for="tag in goodsTags" :label="tag.picUrl" :key="tag.name"
