...
<style>
    ...
    .diy-flash-sale .progress.short {
        width: 284px;
    }
    .diy-flash-sale .progress .line {
        height: 16px;
        width: 2px;
        background-color: #ff4544;
        margin: 0 6px;
    }
    .diy-flash-sale .progress img,.diy-flash-sale .show-discount img {
        width: 14px;
        height: 16px;
        margin-right: 6px;
    }
    .diy-flash-sale .progress>div:first-of-type {
        font-weight: 600;
    }
    .diy-flash-sale .progress .rate {
        position: absolute;
        top: 0;
        left: 0;
        width: 26px;
    ...
    .diy-flash-sale .scroll {
        width: 100%;
        color: #333333;
    }
    .diy-flash-sale .scroll.list-one {
        position: absolute;
        height: 100%;
        width: 340px;
        right: 10px;
    }
    .diy-flash-sale .scroll .list-time {
        font-size: 24px;
        margin: 0 3px;
        background-color: #333333;
        color: #FFFFFF;
    }
    .diy-flash-sale .show-discount {
        color: #ff4544;
        font-size: 24px;
        font-weight: 600;
    }
    ...
    <div class="diy-flash-sale">
        <div class="diy-component-preview" :style="cListStyle">
            <div v-if="data.addGoodsType == 1" >
                <app-g :data="data" :extra="true" :list="cList" sign="flash-sale">
                    <template slot="picEnd">
                        <div :style="cTimerStyle" :flex="cTimerFlex" class="goods-miaosha-timer"
                            ...
                            <div v-if="data.listStyle===1">
                                <img src="statics/img/app/diy/flash-sale.png" style="width: 100%;height: 100%;" alt="">
                            </div>
                    ...
                    <template slot="nameSupply" slot-scope="scope">
                        <div :class="[data.showProgressBar ? 'progress' : 'show-discount',data.listStyle == -1 ? 'short' : '']" :flex="data.showProgressBar || data.textStyle == 2 ? 'main:center cross:center':'dir:left'">
                            <div v-if="data.showProgressBar" class="rate"></div>
                            <div v-if="data.listStyle != 0 && data.listStyle != 3" flex="main:center cross:center">
                                <img src="statics/img/app/diy/fire.png" alt="">
                                <span v-if="scope.goods.discount_type === 1">{{scope.goods.min_discount}}折</span>
                                <span v-if="scope.goods.discount_type === 2">减{{scope.goods.min_discount}}元</span>
                            </div>
                            <div v-if="data.listStyle != 0 && data.listStyle != 3" v-if="data.showProgressBar" class="line"></div>
                            <div v-if="data.showProgressBar">已抢购0件</div>
                        </div>
                        <div v-if="data.listStyle == 0 || data.listStyle == 3" :class="['show-discount',data.listStyle == -1 ? 'short' : '']" :flex="data.textStyle == 2 ? 'main:center cross:center':'dir:left'">
                            <div style="font-size: 20px;" flex="main:center cross:center">
                                <img src="statics/img/app/diy/fire.png" alt="">
                                <span v-if="scope.goods.discount_type === 1">{{scope.goods.min_discount}}折</span>
                                <span v-if="scope.goods.discount_type === 2">减{{scope.goods.min_discount}}元</span>
                            </div>
                        ...
                        <div flex="dir:left" style="height: 100%;width: 100%;overflow-x: auto">
                            <div flex="dir:top" class="m-goods-box" v-for="(goods,index) in cList">
                                ...
                                <div class="goods-end"
                                    ...
                                    <div v-if="data.showProgressBar" class="progress" flex="main:center cross:center">
                                        <div class="rate"></div>
                                        <div flex="main:center cross:center">
                                            <img src="statics/img/app/diy/fire.png" alt="">
                                            <span v-if="goods.discount_type === 1">{{goods.min_discount}}折</span>
                                            <span v-if="goods.discount_type === 2">减{{goods.discount_type}}元</span>
                                        </div>
                                        <div class="line"></div>
                                        <div>已抢购0件</div>
                                    </div>
            ...
            cList() {
                if (!this.data.list || !this.data.list.length) {
                    return [
                        {
                            id: 0,
                            name: '演示商品名称演示商品名称演示商品名称演示商品名称演示商品名称演示商品名称',
                            picUrl: '',
                            price: '100.00',
