...
?>
<style>
    .diy-weekly-buy .diy-component-edit .goods-list {
        line-height: normal;display:flex;
        flex-wrap: wrap;
    }

    .diy-weekly-buy .diy-component-edit .goods-item,
    .diy-weekly-buy .diy-component-edit .goods-add {
        width: 50px;
        height: 50px;
    ...
    .diy-weekly-buy .diy-component-edit .goods-delete {
        position: absolute;
        top: -11px;
        right: -11px;
        width: 25px;
    ...
    .diy-weekly-buy .diy-component-edit .goods-item:hover .goods-delete {
        visibility: visible;
    }

    /*-------------------- 预览部分 --------------------*/
    .diy-weekly-buy .diy-component-preview .goods-list {
        flex-wrap: wrap;
        padding: 10px;
    }

    .diy-weekly-buy .diy-component-preview .goods-item {
        position: relative;
    }

    .diy-weekly-buy .diy-component-preview .goods-tag {
        position: absolute;
        top: 0;
        left: 0;
        width: 64px;
    ...
    .diy-weekly-buy .diy-component-preview .goods-pic {
        width: 100%;
        height: 706px;
    ...
    .diy-weekly-buy .diy-component-preview .goods-name {
        margin-bottom: 10px;
        text-align: left;
    }

    .diy-weekly-buy .diy-component-preview .goods-name.goods-two {
    ...
    .diy-weekly-buy .diy-component-preview .goods-cover-3-2 .goods-pic {
        height: 470px;
    }

    .diy-weekly-buy .diy-component-preview .goods-list-2 .goods-pic {
        height: 343px;
    }

    .diy-weekly-buy .diy-component-preview .goods-list--1 .goods-pic {
        width: 200px;
        height: 200px;
        margin-right: 20px;
    }

    .diy-weekly-buy .diy-component-preview .goods-list--1 .goods-item {
        margin-bottom: 20px;
    }

    .diy-weekly-buy .diy-component-preview .goods-list--1 .goods-item:last-child {
        margin-bottom: 0;
    }

    .diy-weekly-buy .diy-component-preview .goods-underline-price {
        margin-left: 5px;
        white-space: nowrap;
        overflow: hidden;
        text-overflow: ellipsis;
    ...
    .diy-weekly-buy .diy-component-preview .goods-name-static {
        white-space: normal;
        overflow: hidden;
        text-overflow: ellipsis;
        display: -webkit-box;
    ...
    .diy-weekly-buy .diy-component-preview .extra {
        font-size: 24px;
        color: #999999;
    }
</style>
<template id="diy-weekly-buy">
    <div class="diy-weekly-buy">
        <div class="diy-component-preview" :style="cListStyle">
            <app-g :data="data" :extra="true" :list="cList" sign="weekly-buy">
                <template slot="nameSupply">
                    <div class="extra">每月一期</div>
                </template>
            </app-g>
        </div>
            ...
            <el-form label-width="150px" @submit.native.prevent style="padding: 20px 0">
                ...
                <el-form-item label="购买按钮颜色">
                    <div flex="dir:left cross:center">
                        ...
                        <el-input class="box-grow-0" style="margin-left: 10px;margin-top: -1px" size="small" v-model="data.buttonColor"></el-input>
                    </div>
                </el-form-item>
...
<script>
    Vue.component('diy-weekly-buy', {
        template: '#diy-weekly-buy',
        props: {
            value: Object,
        },
        data() {
            ...
            addGoods() {
                ...
                for (let i in this.goodsDialog.selected) {
                    const item = {
                        ...
                        type_name: this.goodsDialog.selected[i].type_name,
