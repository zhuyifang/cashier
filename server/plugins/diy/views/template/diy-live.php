...
<template id="diy-live">
    <div class="diy-live">
        ...
        <div class="diy-component-edit">
            ...
            <el-form label-width="100px" v-loading="loading" @submit.native.prevent style="padding: 20px 0">
                ...
                <el-form-item label="背景颜色">
                    ...
                    <el-input size="small" style="width: 64px;" v-model="data.background"></el-input>
                </el-form-item>
            </el-form>
        </div>
    </div>
