        ...
        <div class="diy-component-edit">
            ...
            <el-form label-width="100px" @submit.native.prevent style="padding: 20px 0">
                <el-form-item label="添加方式">
                    <app-radio turn v-model="data.addType" label="manual">手动添加</app-radio>
                    <app-radio turn v-model="data.addType" label="">自动添加</app-radio>
                ...
                <el-form-item v-if="data.addType === ``" label="优惠券数量">
                    <app-radio turn v-model="data.has_limit" label="">全部</app-radio>
                    <app-radio turn v-model="data.has_limit" label="limit">
                ...
                <el-form-item label="背景效果">
                    <app-radio turn v-model="data.couponBgType" label="pure">纯色</app-radio>
                    <app-radio turn v-model="data.couponBgType" label="gradient">渐变</app-radio>
                </el-form-item>
