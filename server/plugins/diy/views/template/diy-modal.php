...
<!--                                                              size="small">-->
                                                    <app-pick-link @selected="linkSelected" :link="item.link.data ? item.link.data : {url: item.link.url}" :show-customer="false">
...
<!--                                                </el-input>-->
                            ...
                            <el-form-item v-if="data.opened" label="弹窗次数">
                                <app-radio turn v-model="data.times" :label="0">每次</app-radio>
                                <app-radio turn v-model="data.times" :label="1">仅首次</app-radio>
                            </el-form-item>
        ...
        methods: {
            ...
            linkSelected(list, params) {
                ...
                if (this.currentEditListIndex !== null) {
                    ...
                    this.data.list[this.currentEditListIndex].link.data = link;
