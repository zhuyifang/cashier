...
<style>
    .diy-composition .goods-one .el-image {
        height: 100%;
        width: 100%;
    }

    .diy-composition .goods-two .el-image:nth-child(1) {
        position: absolute;
        top: 0;
        left: 0;
        height: 100%;
    ...
    .diy-composition .goods-two .el-image:nth-child(2) {
        position: absolute;
        top: 0;
        right: 0;
        height: 100%;
    ...
    .diy-composition .goods-three .el-image:nth-child(1) {
        position: absolute;
        top: 0;
        left: 0;
        height: 100%;
    ...
    .diy-composition .goods-three .el-image:nth-child(2) {
        position: absolute;
        top: 0;
        right: 0;
        height: 48.23%;
    ...
    .diy-composition .goods-three .el-image:nth-child(3) {
        position: absolute;
        bottom: 0;
        right: 0;
        height: 48.23%;
    ...
    .diy-composition .goods-four .el-image:nth-child(1) {
        position: absolute;
        top: 0;
        left: 0;
        height: 100%;
    ...
    .diy-composition .goods-four .el-image:nth-child(2) {
        position: absolute;
        top: 0;
        right: 0;
        height: 48.8%;
    ...
    .diy-composition .goods-four .el-image:nth-child(3) {
        position: absolute;
        bottom: 0;
        left: calc(50% + 4px);
        height: 48.8%;
    ...
    .diy-composition .goods-four .el-image:nth-child(4) {
        position: absolute;
        bottom: 0;
        right: 0;
        height: 48.8%;
    ...
    .diy-composition .goods-five .el-image:nth-child(1) {
        position: absolute;
        top: 0;
        left: 0;
        height: 100%;
    ...
    .diy-composition .goods-five .el-image:nth-child(2) {
        position: absolute;
        top: 0;
        left: calc(50% + 4px);
        height: 48.8%;
    ...
    .diy-composition .goods-five .el-image:nth-child(3) {
        position: absolute;
        top: 0;
        right: 0;
        height: 48.8%;
    ...
    .diy-composition .goods-five .el-image:nth-child(4) {
        position: absolute;
        bottom: 0;
        left: calc(50% + 4px);
        height: 48.8%;
    ...
    .diy-composition .goods-five .el-image:nth-child(5) {
        position: absolute;
        bottom: 0;
        right: 0;
        height: 48.8%;
    ...
    .diy-composition .diy-component-preview .u-new-price {
        width: auto;
    }
</style>
                ...
                <div v-for="item in cList" :style="cItemStyle">
                    <div class="goods-item"
                        ...
                        <div v-if="data.showGoodsTag" class="goods-tag"
                             :style="'background-image: url('+data.goodsTagPicUrl+');border-top-left-radius:'+data.c_border_top+'px;'"></div>
...
<!--                                     <div style="color: #ff4544;white-space: nowrap;overflow: hidden;text-overflow: ellipsis;letter-spacing: -1px;">
                                    ...
                                    <u-new-price v-if="item" :price-content="'￥' + item.price" :list-style="0"></u-new-price>
                                </div>
                        ...
                        <el-form-item label="下边距">
                            <div flex="dir:left">
                                <el-slider style="width: 50%;margin-right: 20px" input-size="mini"
                                           ...
                                           :max="50" :min="0"
                                           :show-tooltip="false"></el-slider>
                                <el-input-number size="small" v-model="data.c_padding_bottom" :min="0"
                                                 :max="50" label="按钮圆角"></el-input-number>
                                <div style="margin-left: 10px">px</div>
                            </div>
                        </el-form-item>
                        ...
                        <el-form-item label="上圆角">
                            <div flex="dir:left">
                                <el-slider style="width: 50%;margin-right: 20px" input-size="mini"
                                           ...
                                           :max="50" :min="0"
                                           :show-tooltip="false"></el-slider>
                                <el-input-number size="small" v-model="data.c_border_top" :min="0"
                                                 :max="50" label="按钮圆角"></el-input-number>
                                <div style="margin-left: 10px">px</div>
                            </div>
                        </el-form-item>
                        <el-form-item label="下圆角">
                            <div flex="dir:left">
                                <el-slider style="width: 50%;margin-right: 20px" input-size="mini"
                                           ...
                                           :max="50" :min="0"
                                           :show-tooltip="false"></el-slider>
                                <el-input-number size="small" v-model="data.c_border_bottom" :min="0"
                                                 :max="50" label="按钮圆角"></el-input-number>
                                <div style="margin-left: 10px">px</div>
                            </div>
                        </el-form-item>
