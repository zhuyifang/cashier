...
class SettingForm extends Model
{
    ...
    public $salt;
    public $token;
    public $wechat_pay_cert_pem = '';
    public $wechat_pay_key_pem = '';

    public function rules()
    {
        return [
            [['app_key', 'app_secret', 'mch_id', 'pay_app_id','pay_app_secret','alipay_app_id', 'alipay_private_key','alipay_public_key', 'salt', 'token', 'wechat_pay_cert_pem', 'wechat_pay_key_pem'], 'trim'],
            [['app_key', 'app_secret', 'salt'], 'required'],
