...
use app\forms\api\order\customization\CustomizationOrderForm;
use app\forms\api\order\customization\CustomizationOrderSubmitForm;
...
class OrderController extends ApiController
{
    ...
    public function actionFormOrderPreview()
    {
        $form = new CustomizationOrderSubmitForm();
        $form->form_data = \Yii::$app->serializer->decode(\Yii::$app->request->post('form_data'));
        return $this->asJson($form->setPluginData()->preview());
    }

    public function actionFormOrderSubmit()
    {
        $form = new CustomizationOrderSubmitForm();
        $form->form_data = \Yii::$app->serializer->decode(\Yii::$app->request->post('form_data'));
    ...
    public function actionGoodsForm()
    {
        $form = new CustomizationOrderForm();
        $form->attributes = \Yii::$app->request->post();
    ...
    public function actionCustomization()
    {
        ...
        return $this->asJson($form->getCustomization());
    }
}
