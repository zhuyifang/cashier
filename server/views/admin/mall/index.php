                ...
                <el-table-column prop="name" label="商城名称">
                    <template slot-scope="scope">
                        ...
                        <div class="mall-user-info">
                            ...
                            <span style=" vertical-align: middle;">{{scope.row.user.username}}</span>
                        </div>
                    </template>
                </el-table-column>
    ...
    <el-dialog title="创建商城" :visible.sync="createMallDialogVisible" width="40%" :close-on-click-modal="false">
        <el-form label-width="100px" size="small" :model="createMallForm" :rules="createMallRules" ref="createMallForm">
            ...
            <el-form-item label="商城有效期" prop="expired_at" ref="expired_at">
                <el-date-picker
                                :disabled="isCheckExpired && adminInfo.expired_at == '0000-00-00 00:00:00'"
                                type="datetime"
                ...
                <el-checkbox v-if="adminInfo.expired_at == '0000-00-00 00:00:00'" v-model="isCheckExpired" @change="checkExpiredAt">永久</el-checkbox>
            </el-form-item>
    ...
    new Vue({
        ...
        methods: {
                ...
                this.$refs[formName].validate(valid => {
                    if (valid) {
                        ...
                        this.$request({
                            ...
                            method: 'post',
                            data: {
                                id: this.createMallForm.id,
                                name: this.createMallForm.name,
                                expired_at: this.createMallForm.expired_at,
                                is_check_expired: this.isCheckExpired,
                            },
                        }).then(e => {
            ...
            checkExpiredAt(value) {
                ...
                if (value) {
                    this.createMallForm.expired_at = new Date()
                } else {
                    this.createMallForm.expired_at = ''
                }
                this.$refs['expired_at'].clearValidate();
            ...
            setOptions() {
                ...
                let minutes = '59';
                let seconds = '59';
                if (that.adminInfo.expired_at != '0000-00-00 00:00:00') {
                    let date = new Date(that.adminInfo.expired_at)
                ...
                return {
                    ...
                    selectableRange: '00:00:00 - ' + hours + ':' + minutes + ':' + seconds
                }
            }
        }
    });
