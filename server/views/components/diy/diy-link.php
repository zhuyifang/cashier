        ...
        <div class="diy-component-preview">
            <div class="diy-link" :style="cStyle" flex="cross:center">
                <div :class="style" flex="dir:left cross:center">
                    ...
                    <div v-if="data.arrowsSwitch" style="font-size: 28px;color: #999;padding-right: 45px;">更多</div>
        ...
        <div v-show="!hidden" class="diy-component-edit">
            ...
            <el-form label-width="100px" @submit.native.prevent style="padding: 20px 0">
                ...
                <el-form-item label="字体大小">
                    <app-radio turn v-model="data.fontSize" label="36">大</app-radio>
                    <app-radio turn v-model="data.fontSize" label="28">中</app-radio>
                    <app-radio turn v-model="data.fontSize" label="24">小</app-radio>
                </el-form-item>
                ...
                <el-form-item label="标题样式">
                    <app-radio turn v-model="data.style" label="1">样式1</app-radio>
                    <app-radio turn v-model="data.style" label="2">样式2</app-radio>
                    <app-radio turn v-model="data.style" label="3">样式3</app-radio>
                    <app-radio turn v-model="data.style" label="4">样式4</app-radio>
                    <app-radio turn v-model="data.style" label="5">样式5</app-radio>
                </el-form-item>
                <el-form-item v-if="data.style == '1'" label="标题位置">
                    <app-radio turn v-model="data.position" label="left">居左</app-radio>
                    <app-radio turn v-model="data.position" label="center">居中</app-radio>
                    <app-radio turn v-model="data.position" label="right">居右</app-radio>
                </el-form-item>
