            ...
            <el-form @submit.native.prevent label-width="150px" style="margin-right: 20px">
                ...
                <div class="body">
                    <el-form-item label="指示器">
                        <app-radio turn v-model="data.mode" label="rect">条状</app-radio>
                        <app-radio turn v-model="data.mode" label="round">圆点</app-radio>
                    </el-form-item>
...
<!--                                            </el-input>-->
                ...
                <div class="body">
                    <el-form-item label="轮播方式">
                        <app-radio turn v-model="data.autoplay" :label="0">自动播放</app-radio>
                        <app-radio turn v-model="data.autoplay" :label="1">手动播放</app-radio>
                    </el-form-item>
                    ...
                    <el-form-item label="轮播速度">
                        <app-radio turn v-model="data.duration" :label="750">标准</app-radio>
                        <app-radio turn v-model="data.duration" :label="1000">较慢</app-radio>
                        <app-radio turn v-model="data.duration" :label="500">较快</app-radio>
                    </el-form-item>
                </div>
