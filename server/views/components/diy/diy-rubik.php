...
<template id="diy-rubik">
    <div class="diy-rubik">
        ...
        <div v-show="!hidden" class="diy-component-edit">
            ...
            <el-form label-width="100px" @submit.native.prevent style="padding: 20px 0" size="mini">
                        ...
                        <template v-else>
                            <el-card shadow="never">
                                ...
                                <el-form-item label="选择链接">
                                    <app-pick-link title="选择链接" @selected="selectLink" :show-customer="false" :link="rubikLink()">
...
<!--                                        </el-input>-->
                        ...
                        <el-form-item label="热区划分">
                            <app-hotspot :multiple="true" :pic-list="data.list" :hotspot-array="data.hotspot"
                                         width="750px" :height="data.height === 'auto' ? data.height : data.height + 'px'" @confirm="selectHotspot"
                                         :is-link="true">
    ...
    Vue.component('diy-rubik', {
        ...
        methods: {
            ...
            rubikLink () {
                ...
                return this.data.list[this.rubik].link
            }
        }
    });
</script>
