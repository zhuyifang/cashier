...
<div id="app-activity-list" v-cloak>
    <el-card  class="box-card" shadow="never" style="border:0"
        ...
        <div class="table-body">
            <app-search :is-show-cat="false" :tabs="tabs" date-label="活动时间" :new-search="search" :place-holder="search_placeholder" @to-search="toSearch" date_label="活动时间" :new-active-name="newActiveName"></app-search>
            <div class="shelves">
            ...
            <el-table
                    ...
                    <template slot-scope="scope">
                        <div flex="box:first">
                            <div style="padding-right: 10px;">
                                <app-image v-if="sign == 'weekly_buy'" mode="aspectFill" :src="scope.row.goodsWarehouse.cover_pic"></app-image>
                                <app-image v-else mode="aspectFill" :src="scope.row.goods_cover_pic"></app-image>
                            </div>
                            <div style="display: -webkit-box;height:50px;line-height: 25px;-webkit-box-orient: vertical;-webkit-line-clamp: 2;">
                                {{sign == 'weekly_buy' ? scope.row.name : scope.row.goods_name}}
                            </div>
                        </div>
                    </template>
                </el-table-column>
                ...
                <slot name="before_status"></slot>
                <el-table-column
                    label="活动时间"
                    :width="time_width"
                    :show-overflow-tooltip="sign == 'weekly_buy' ? false : true">
                    <template slot-scope="scope">
                        ...
                        <template v-else-if="sign == 'weekly_buy'">
                            <div>
                ...
                <el-table-column
                    ...
                    >
                    <template slot-scope="scope">
                        <el-button type="text" circle size="mini" @click="edit(scope.row)" v-if="no_edit === 0 && (scope.row.status_cn !== '已结束' || sign == 'weekly_buy')">
                            <el-tooltip class="item" effect="dark" content="编辑" placement="top">
                                <img src="statics/img/mall/edit.png" alt="">
                            </el-tooltip>
                        </el-button>
                        <el-button type="text" circle size="mini" @click="destroy(scope.row)" v-if="sign == 'weekly_buy'">
                            <el-tooltip class="item" effect="dark" content="删除" placement="top">
                                <img src="statics/img/mall/del.png" alt="">
                            </el-tooltip>
                        </el-button>
                        <el-button type="text" circle size="mini" @click="detail(scope.row)" v-if="sign !== 'miaosha' && sign !== 'weekly_buy' && scope.row.status_cn !== '未开始'">
