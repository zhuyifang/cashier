        ...
        <el-form ref="ruleForm" label-width="150px" :model="ruleForm" :rules="rules"
            ...
            <el-card shadow="never">
                <el-form-item label="查询类型选择" prop="express_select_type">
                    ...
                    <el-link href="https://api.kuaidi100.com/extend/register?code=0164887300404db5abc0b1a4bb743699"
                             type="primary"
                             v-if="ruleForm.express_select_type === 'kd100'"
                             style="line-height:1;float:left"
                             target="_blank"
                             :underline="false"
                    >快递100接口申请</el-link>
                </el-form-item>
