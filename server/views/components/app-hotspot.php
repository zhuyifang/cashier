                    ...
                    <div class="right" v-if="index > -1">
                        ...
                        <el-form-item label="热区链接" v-if="isLink">
                            <app-pick-link style="margin-left: 10px" title="选择链接" @selected="selectLink"
                                           :show-customer="false" :link="hotspotList[index].link ? hotspotList[index].link : {}">
...
<!--                                </el-input>-->
                        ...
                        <el-form-item prop="params" label="自定义按钮" v-if="mode == 'auth' && hotspotList[index].open_type == 'link'">
                            <div @click="searchIndex(index)">
<!--                            <el-input size="small" v-model="hotspotList[index]['link']['url']"-->
<!--                                      class="input-with-select"-->
<!--                                      autocomplete="off" disabled>-->
                                <app-pick-link @selected="selectPageUrl"
                                               :show-customer="false" :link="hotspotList[index].link.data ? hotspotList[index].link.data : {url: hotspotList[index].link.url}">
