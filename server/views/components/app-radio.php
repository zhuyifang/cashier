...
<style>
    ...
    .app-radio.is-checked.turn {
        color: #ffffff;
    }

    .app-radio.is-checked.turn .app-radio-label {
        color: #606266;
    }

    .app-radio.turn.is-checked .app-radio-point .app-radio-inside-point {
        background: #409EFF;
...
<template id="app-radio">
    <label class="app-radio"
           :class="[
           value === label ? 'is-checked' : '', turn ? 'turn' : ''
           ]"
           @click="onClick">
        <span class="app-radio-point">
            <span class="app-radio-inside-point"></span>
        </span>
        <span class="app-radio-label" :style="{color: value === label ? '#409EFF': 'inherit'}">
            <slot></slot>
        </span>
