        ...
        <el-dialog title="发货" :visible.sync="dialogVisible" width="35%" @close="closeDialog">
            ...
            <el-table
                ...
                <el-table-column
                    ...
                    <template slot-scope="scope">
                        <el-tag v-if="scope.row.expressRelation && order.sign != 'weekly_buy'" type="success" size="mini">已发货</el-tag>
        ...
        methods: {
            ...
            getExpressData() {
                ...
                self.orderDetail.forEach(row => {
                    if (!row.expressRelation || self.order.sign == 'weekly_buy') {
                        setTimeout(() => {
            ...
            getExpressId: function (newVal) {
                let self = this;
                if (self.expressId > 0 && self.order.sign != 'weekly_buy') {
                    self.orderDetail = [];
                    self.order.detailExpress.forEach(function (item) {
                        if (item.id == self.expressId) {
            ...
            send_order(e, formName) {
                ...
                if(this.order.sign == 'weekly_buy' && this.order.plugin_data.extra.weekly_buy.now_express) {
                    e.week_number = this.order.plugin_data.extra.weekly_buy.now_express.week_number;
                }
            ...
            getPrint(e) {
                ...
                request({
                    ...
                    if (e.data.code == 0) {
                        ...
                        this.adminPrintTemplate = imgBase64 || e.data.data.PrintTemplate;
            ...
            selectInit(row, index) {
                if (row.expressRelation && this.order.sign != 'weekly_buy') {
                    return false;
                } else {
                    return true;
                }
            ...
            citySendSubmit(e) {
                ...
                if(e.week_number) {
                    para.week_number = e.week_number
                }
                request({
                    params: {
                        r: 'mall/order/send',
