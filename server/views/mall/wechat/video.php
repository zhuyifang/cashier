    ...
    <el-card shadow="never" v-loading="cardLoading" style="border:0" body-style="background-color: #f3f3f3;padding: 10px 0 0;">
        ...
        <div class="form_box">
            <el-form :model="ruleForm"
                ...
                <el-form-item label="分销等级可用权限" prop="is_video_number_member">
                    <el-switch v-model="ruleForm.is_video_number_member"
                               :active-value="1"
                               :inactive-value="0">
                    </el-switch>
                </el-form-item>
                <el-form-item v-if="ruleForm.is_video_number_member" label="分销等级" prop="video_number_member_list">
                    <el-tag
                    ...
                    <el-button @click="getShareLevel" size="small">选择分销等级</el-button>
                </el-form-item>
            ...
            <el-dialog title="选择分销等级" :visible.sync="memberDialogVisible">
                <div class="input-item">
                    <el-input @keyup.enter.native="getShareLevel" size="small" placeholder="请输入分销等级名称" v-model="shareKeyword" clearable @clear="getShareLevel">
              ...
              <el-table v-loading="shareListLoading" :data="shareList" @selection-change="handleSelectionChange">
                ...
                <el-table-column property="name" label="分销等级名称"></el-table-column>
              </el-table>
