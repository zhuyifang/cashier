                                ...
                                <div class="goods-info">
                                    ...
                                    <div style="margin-bottom: 24px;">
                                        ...
                                        <div style="margin-top: 10px"
                                             v-if="goods.goods_type === 'form-goods' && ((goods.goods_info.goods_attr.customization && goods.goods_info.goods_attr.customization.length ) ||  (goods.goods_info.goods_attr.dateList && goods.goods_info.goods_attr.dateList.length))">
                                            <goods-form :detail-id="goods.id">
                                                <el-button style="padding:6px 16px; font-size: 12px;" marsize="mini"
                                                           type="primary">
                                                    查看定制详情
                                                </el-button>
                                            </goods-form>
