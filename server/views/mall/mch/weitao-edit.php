...
<style>
    ...
    .mobile-framework-header {
        ...
        padding-top: 20px;
        cursor: pointer;
        background: url('statics/img/mall/mch/weitao/phone-bar.png') no-repeat;
...
<div id="app" v-cloak>
    <el-card v-loading="loading" shadow="never" style="border:0" body-style="background-color: #f3f3f3;padding: 10px 0 0;">
        <div slot="header"><span style="color: #C0C4CC;">店铺微淘</span> / {{title}}</div>
                    ...
                    <el-tab-pane label="基础设置" name="first">
                        <div class="box">
                            ...
                            <div class="content">
                                ...
                                <el-form-item label="微淘列表布局方式" prop="layout_type">
                                    <div flex="dir:left">
                                        <div 
                                ...
                                <el-form-item label="摘要" prop="abstract">
                                    <template slot="label">
                                        <span>摘要</span>
                                        <el-tooltip effect="dark" content="微淘内容的简介，用于列表上显示" placement="top">
                        ...
                        <div class="box">
                            ...
                            <div class="content">
                                ...
                                <el-form-item v-if="ruleForm.add_goods_type == 1" label="商品数量" prop="add_goods_number">
                                    ...
                                    <span style="color: #C0C4CC;">注：每篇微淘文章最多添加{{goodsDialog.max}}个内嵌商品</span>
                                </el-form-item>
                ...
                typeList: [
                    {
                        ...
                        example: 'statics/img/mall/mch/weitao/big-example.png',
                        is_active: 1
                    },
                    {
                        label: '宫格模式',
                        ...
                        example: 'statics/img/mall/mch/weitao/grid-example.png',
                        is_active: 0
                    },
                    {
                        label: '列表模式',
                ...
                request({
                    ...
                    if (e.data.code == 0) {
                        ...
                        if (e.data.data.detail) {
                            ...
                            this.components = e.data.data.detail.detail
