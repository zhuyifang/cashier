                        ...
                        <el-tab-pane label="其他显示" name="third">
                            <div class="form-body" style="padding: 40px;display: flex;">
                                <div class='left-setting-menu'>
                                    ...
                                    <el-form-item :class='active_setting == "is_show_parent_name" ? "active":""'
                                                  @click.native='chooseSetting("is_show_parent_name")' label="分销推荐人显示开关"
                                                  prop="is_show_parent_name">
                                        <el-switch
                                                v-model="ruleForm.setting.is_show_parent_name"
                                                :active-value="1"
                                                :inactive-value="0">
                                        </el-switch>
                                    </el-form-item>
                                ...
                                <div style='background-color: #F3F5F6;padding: 30px;border-radius: 10px;'
                                    ...
                                    <div class="item-img">
                                        <app-image v-if='active_setting == "is_not_share_show"' mode="aspectFill"
                                                   ...
                                                   style="margin-bottom: 20px" height="500" width="280"></app-image>
                                        <app-image v-if='active_setting == "is_show_parent_name"' mode="aspectFill"
                                                   src="statics/img/mall/is_show_parent_name.png"
                                                   style="margin-bottom: 20px" height="500" width="280"></app-image>
                                        <app-image v-if='active_setting == "is_mobile_auth"' mode="aspectFill"
                                                   src="statics/img/mall/auth_mobile.png"
                                                   style="margin-bottom: 20px" height="500" width="280"></app-image>
...
<!--                                              v-model="ruleForm.setting.quick_customize_link_url" autocomplete="off">-->
                                        <app-pick-link @selected="selectQuickCustomize"
                                                       :show-customer="false" :link="link">
...
<script>
    const app = new Vue({
        ...
        methods: {
            ...
            selectQuickCustomize(e) {
                e.map((item, index) => {
                    ...
                    this.ruleForm.setting.quick_customize_link = item;
                });
            },
            quickCustomizePic(e) {
                if (e.length) {
        ...
        computed: {
            ...
            link() {
                if (this.ruleForm.setting.quick_customize_link) {
                    return this.ruleForm.setting.quick_customize_link;
                } else {
                    return {
                        url: this.ruleForm.setting.quick_customize_link_url
                    };
                }
            }
        },
