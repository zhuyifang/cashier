            ...
            <el-table :data="list" size="small" border v-loading="loading" style="margin-bottom: 15px">
                ...
                <el-table-column label="基本信息" width="140px">
                    <template slot-scope="scope">
                        ...
                        <img width="24px" height="24px" :src="scope.row.user.platform_icon" alt="">
                ...
                <el-table-column label="提现方式">
                    <template slot-scope="scope">
                        ...
                        <template v-if="scope.row.use_qrcode == 1 && scope.row.extra.qrcode">
                            <img style="cursor: pointer;height: 60px;" :src="scope.row.extra.qrcode" @click="openBig(scope.row.extra.qrcode)" alt="">
                        </template>
                        <template v-else-if="scope.row.type == 'wechat'">
                            <div>微信昵称:{{scope.row.extra.name}}</div>
                            <div>微信号:{{scope.row.extra.mobile}}</div>
                        </template>
                        <template v-else-if="scope.row.type == 'alipay'">
                            <div>支付宝姓名:{{scope.row.extra.name}}</div>
                            <div>支付宝账号:{{scope.row.extra.mobile}}</div>
                        </template>
                        <template v-else-if="scope.row.type == 'bank'">
