        ...
        <el-form  label-width="100px" ref="ruleForm" @submit.native.prevent>
            <el-form-item  label="页面设置" props="username" >
                <div>
                    ...
                    <div>
                        <el-radio v-model="printSetting.page_type"  :label="2">自动换页打印</el-radio>
                    </div>
                </div>
            </el-form-item>
                ...
                <el-card shadow="never" class="mt-24">
                    ...
                    <template v-if="edit">
                        ...
                        <el-form label-width="125px">
                            ...
                            <div style="height: 180px;border: 1px solid #e8eaee;width: 770px;background-color: #f5f7fa;margin-bottom: 25px;"
                                 v-if="show === 0">
                                ...
                                <div style="height: 70px;border: 1px solid #e8eaee;width: 770px;background-color: #f5f7fa;line-height:70px;padding-left: 18px;margin-bottom: 25px;">
                                    <el-checkbox v-model="order.hidden_bar_code" label="隐藏条形码"></el-checkbox>
                                </div>
                            </div>
                            <div style="height: 70px;border: 1px solid #e8eaee;width: 770px;background-color: #f5f7fa;line-height:70px;padding-left: 18px;margin-bottom: 25px;"
                                 v-if="show === 1">
                            ...
                            <div style="margin-bottom: 25px;" class="goodsInf" v-if="show === 3">
                                ...
                                <el-checkbox @change="goodsInf.attr = goodsInf.name" v-model="goodsInf.name" label="商品信息"></el-checkbox>
                        ...
                        <div id="canvas"
                            ...
                            <div id="invoice"
                                ...
                                width: order.hidden_bar_code ? '100%' : '58%',
                                fontSize: headline.font / (4/3) + 'px',height: '50px',lineHeight: '50px', letterSpacing: headline.space / (4/3)+'px',backgroundColor: `${show === 0? '#ecf4ff' : '#ffffff'}`, borderBottom: `${!order.date && !order.time && !order.orderNumber ? '1px solid #000000' : 'none'}`}"
                                    ...
                                    <div v-if="!order.hidden_bar_code" flex="cross:center main:center" style="width: 42%;height: 50px;border-left: 1px solid #000000;text-align: center">
                                ...
                                <div @mouseenter="mouseenter(2, true)"
                                    ...
                                    <div v-if="personalInf.name || personalInf.nickname || personalInf.phone || personalInf.address || personalInf.payMethod || personalInf.shipMethod"
                                         ...
                                         :style="{width: `${personalInf.leaveComments ? '70%' : '100%'}`,borderBottom:'1px solid #000000',borderRight: `${ personalInf.leaveComments ? '1px solid #000000': 'none'}`, padding:' 10px 10px 10px 0.5%'}"
                                    >
                                    ...
                                    <div :style="{width: `${personalInf.name || personalInf.nickname || personalInf.phone || personalInf.address || personalInf.payMethod || personalInf.shipMethod? '30%' : '100%'}`,borderBottom:'1px solid #000000',padding: '10px 10px 10px 0.5%', fontSize:'10px', lineHeight:'1.2'}"
                                ...
                                <div @click="showTab(3)"
                                    ...
                                    <div style="display: flex;border-bottom:1px solid #000000;position: relative;left: -0.5px;"
                                         v-if="goodsInf.serial || goodsInf.name || goodsInf.attr || goodsInf.number || goodsInf.univalent || goodsInf.article_number || goodsInf.unit || goodsInf.article_number">
                                        ...
                                        <div  style="display: flex;min-width: 0;-webkit-box-flex: 1;flex-grow: 1;flex-shrink: 1;" v-if="goodsInf.name || goodsInf.attr ||  goodsInf.article_number">
                                            <div :style="{width: goodsInf.article_number ? '75%' : '100%'}"  v-if="goodsInf.name || goodsInf.attr" style="min-width: 0;flex-grow: 1;flex-shrink: 1;-webkit-box-flex: 1;border-left: 1px solid #000000;height: 30px;line-height: 30px;padding-left: .5%;font-size:10px;">商品信息
                                            </div>
                                            <div :style="{width: goodsInf.name || goodsInf.attr ? '25%' : '100%'}"  v-if="goodsInf.article_number" style="min-width: 0;flex-grow: 1;flex-shrink: 1;-webkit-box-flex: 1;border-left: 1px solid #000000;height: 30px;line-height: 30px;padding-left: 0.5%;font-size:10px;">货号
                                            </div>
                                        </div>
                                        ...
                                        <div style="width: 30%;" flex="dir:left" class="price-area">
                                            <div :style="{'width': !goodsInf.univalent ? 18/30*100 + '%' : !goodsInf.unit ? 15/30*100 + '%' : 12/30*100 + '%' }"
                                                 v-if="goodsInf.unitPrice">单价
                                            </div>
                                            <div :style="{'width': !goodsInf.unitPrice ? 18/30*100 + '%' : !goodsInf.unit ? 15/30*100 + '%' : 12/30*100 + '%' }"
                                                 v-if="goodsInf.univalent">小计
                                            </div>
                                            <div :style="{'width': !goodsInf.univalent ? 12/30*100 + '%' : !goodsInf.unitPrice ? 12/30*100 + '%' : 6/30*100 + '%' }"
                                    ...
                                    <div style="display: flex;border-bottom: 1px solid #000000;position: relative;left: -0.5px;"
                                       ...
                                       <div style="display: flex;min-width: 0;-webkit-box-flex: 1;flex-grow: 1;flex-shrink: 1;" v-if="goodsInf.name || goodsInf.attr || goodsInf.article_number">
                                           <div :style="{width: goodsInf.article_number ? '75%' : '100%'}" style="min-width: 0;flex-grow: 1;flex-shrink: 1;-webkit-box-flex: 1;word-wrap: break-word;border-left: 1px solid #000000;font-size:10px;padding: 10px 10px 10px 0.5%;position: relative"
                                                v-if="goodsInf.name || goodsInf.attr">
                                               <span>男士羊毛衫:规格:默认</span>
                                           </div>
                                           <div :style="{width: goodsInf.name || goodsInf.attr ? '25%' : '100%'}" style="min-width: 0;flex-grow: 1;flex-shrink: 1;-webkit-box-flex: 1;word-wrap: break-word;border-left: 1px solid #000000;font-size:10px;padding: 10px 10px 10px 0.5%;position: relative"
                                        ...
                                        <div style="width: 30%;" flex="dir:left" class="price-show-area">
                                            <div :style="{'width': !goodsInf.univalent ? 18/30*100 + '%' : !goodsInf.unit ? 15/30*100 + '%' : 12/30*100 + '%' }"
                                                 v-if="goodsInf.unitPrice">￥10
                                            </div>
                                            <div :style="{'width': !goodsInf.unitPrice ? 18/30*100 + '%' : !goodsInf.unit ? 15/30*100 + '%' : 12/30*100 + '%' }"
                                                 v-if="goodsInf.univalent">￥110
                                            </div>
                                            <div :style="{'width': !goodsInf.univalent ? 12/30*100 + '%' : !goodsInf.unitPrice ? 12/30*100 + '%' : 6/30*100 + '%' }"
                                                 v-if="goodsInf.unit">
                                ...
                                <div @click="showTab(4)"
                                    ...
                                    <div :style="{width:`${!sellerInf.remark ? '100%': '70%'}`,padding: '10px 10px 10px .5%', fontSize: '10px',borderRight: `${!sellerInf.remark ? 'none' : '1px solid #000000'}`}"
                                    ...
                                    <div :style="{width: `${!sellerInf.branch && !sellerInf.name && !sellerInf.phone && !sellerInf.postcode && !sellerInf.address ? '100%' : '30%'}`,padding: '10px 10px 10px .5%', fontSize: '10px'}"
                   ...
                   <div style="display: inline-block;position: relative;white-space: nowrap;width: 100%;height: 50px">
                    ...
                    <div :style="{display: 'flex', boxSizing: 'border-box'}"
                        ...
                        <div v-if="printPar.personalInf.name || printPar.personalInf.nickname || printPar.personalInf.phone || printPar.personalInf.address  || printPar.personalInf.payMethod || printPar.personalInf.shipMethod"
                             :style="{width: `${printPar.personalInf.leaveComments ? '70%' : '100%'}`, boxSizing: 'border-box', borderBottom:'1px solid #000000',borderRight: `${ printPar.personalInf.leaveComments ? '1px solid #000000': 'none'}`, padding:'10px 10px 10px 0.5%'}"
                        >
                        ...
                        <div :style="{width: `${printPar.personalInf.name || printPar.personalInf.nickname || printPar.personalInf.phone || printPar.personalInf.address  || printPar.personalInf.payMethod || printPar.personalInf.shipMethod ? '30%' : '100%'}`,borderBottom:'1px solid #000000',padding: '10px 10px 10px 0.5%', fontSize:'10px', boxSizing: 'border-box', lineHeight:'1.2', boxSizing: 'border-box'}"
