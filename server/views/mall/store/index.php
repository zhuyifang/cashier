            ...
            <el-table
                ...
                <el-table-column
                    ...
                    <template slot-scope="scope">
                        <app-ellipsis :height="44" :line="2">{{scope.row.name}}</app-ellipsis>
                    </template>
                </el-table-column>
                <el-table-column
                        label="封面图"
                ...
                <el-table-column
                        ...
                        width="120">
                    <template slot-scope="scope">
                        <app-ellipsis :height="44" :line="1">{{scope.row.mobile}}</app-ellipsis>
                    </template>
                </el-table-column>
                <el-table-column
                        label="门店地址"
                        width="220">
                    <template slot-scope="scope">
                        <app-ellipsis :height="44" :line="2">{{scope.row.address}}</app-ellipsis>
                    </template>
                </el-table-column>
                <el-table-column
                        label="经纬度"
                        width="220">
                    <template slot-scope="scope">
                        <app-ellipsis :height="44" :line="1">{{scope.row.latitude_longitude}}</app-ellipsis>
                    </template>
                </el-table-column>
