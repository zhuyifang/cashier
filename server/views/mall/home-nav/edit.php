...
<!--                        <div flex="box:last">-->
                            <el-input disabled v-model="ruleForm.url" style="display: none"></el-input>
                            <app-pick-link @selected="linkUrl" :show-customer="false" :link="ruleForm.link ? ruleForm.link : {url: ruleForm.url}">
