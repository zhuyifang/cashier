    ...
    <el-card class="box-card" shadow="never" style="border:0"
        ...
        <div class="form-body">
            <el-form :model="ruleForm" label-width="150px" :rules="rules" ref="ruleForm" size="mini">
                ...
                <el-form-item label="素材管理分组" prop="is_download" v-if="ruleForm.is_download === 1">
                    <el-select v-model="ruleForm.group_id">
                        <el-option label="全部" :value="0"></el-option>
                        <el-option v-for="(item, index) in group_list" :label="item.name" :value="item.id" :key="index"></el-option>
                    </el-select>
                </el-form-item>
        ...
        methods: {
            ...
            getGroupList() {
                this.$request({
                    ...
                    if (e.data.code === 0) {
                        this.group_list = e.data.data.list
                    } else {
