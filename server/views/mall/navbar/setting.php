                ...
                <el-row>
                    <el-col :span="18">
                        ...
                        <el-form-item label="导航链接" prop="url">
                            <div flex="box:last">
                                <el-input disabled v-model="dialogRuleForm.url" style="display: none"></el-input>
<!--                                <div>-->
...
<script>
    const app = new Vue({
        ...
        methods: {
            ...
            selectNavUrl(e) {
                ...
                e.forEach(function (item, index) {
                    ...
                    Vue.set(self.dialogRuleForm, 'link', item);
                })
            },
            // 恢复默认
            restoreDefault() {
        ...
        computed: {
            link() {
                if (this.dialogRuleForm.link) {
                    return this.dialogRuleForm.link
                } else {
                    return {
                        url: this.dialogRuleForm.url
                    };
                }
            }
        }
