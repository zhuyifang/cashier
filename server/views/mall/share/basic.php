                    ...
                    <div>
                        <el-row>
                            <el-col :span="20">
                                ...
                                <el-form-item label="成为分销商是否需要条件" prop="is_condition" required>
                                    <el-radio-group v-model="ruleForm.is_condition">
                                        <el-radio :label="0">无条件</el-radio>
                                        <el-radio :label="1">有条件</el-radio>
                                    </el-radio-group>
                                </el-form-item>
                                <el-form-item required v-if="ruleForm.is_condition == 1">
                                    <label slot="label">分销商的条件
                                        <el-tooltip class="item" effect="dark"
                                                    content="满足任一条件可申请成为分销商"
                                                    placement="top">
                                            <i class="el-icon-info"></i>
                                        </el-tooltip>
                                    </label>
                                    <div>
                                        <el-checkbox-group v-model="ruleForm.new_become_condition">
                                            <el-checkbox label="one_consume">单次消费</el-checkbox>
                                            <el-checkbox label="total_consume">累计消费</el-checkbox>
                                            <el-checkbox label="buy_goods">购买商品</el-checkbox>
                                            <!-- <el-checkbox :label="3">无条件</el-checkbox> -->
                                        </el-checkbox-group>
                                    </div>
                                    <div v-if="ruleForm.new_become_condition.indexOf('one_consume') > -1">
                                        <el-form-item prop="auto_share_val">
                                            <el-input type="number" v-model.number="ruleForm.auto_share_val">
                                                <template slot="prepend">单次消费金额</template>
                                                <template slot="append">元</template>
                                            </el-input>
                                        </el-form-item>
                                    </div>
                                    <div v-if="ruleForm.new_become_condition.indexOf('total_consume') > -1">
                                        <el-form-item prop="total_consume">
                                            <el-input type="number" v-model.number="ruleForm.total_consume">
                                                <template slot="prepend">累计消费金额</template>
                                                <template slot="append">元</template>
                                            </el-input>
                                        </el-form-item>
                                    </div>
                                    <div v-if="ruleForm.new_become_condition.indexOf('buy_goods') > -1">
                                ...
                                <el-form-item v-if="ruleForm.is_condition == 1" label="消费条件" required>
                                    <div>
