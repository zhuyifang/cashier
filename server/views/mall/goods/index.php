            ...
            <el-table-column v-if="!is_mch" label="是否加入快速购买">
                <template slot-scope="scope">
                    <el-tooltip class="item" effect="dark"
                                content="虚拟/定制商品不能加入快速购买"
                                v-if="scope.row.goodsWarehouse.type === 'ecard' || scope.row.goodsWarehouse.type === 'form-goods'"
                                placement="top">
                        <el-switch
                                :active-value="1"
                                :inactive-value="0"
                                :disabled="scope.row.goodsWarehouse.type === 'ecard' || scope.row.goodsWarehouse.type === 'form-goods'"
