                ...
                <el-card style="margin-top: 10px;" shadow="never" v-for="(item, index) in list" :key="index">
                    ...
                    <el-row>
                        <el-col :span="12">
                            ...
                            <el-form-item v-if="item.type == 2" label="自定义推荐商品">
                                <el-switch :active-value="1" :inactive-value="0"
                                           v-model="form[item.key].is_custom"></el-switch>
                                <span>{{form[item.key].is_custom ? "最多添加20件商品" : "按商品列表排序显示前10件商品"}}</span>
                            ...
                            <el-form-item label="推荐商品显示数量" v-else>
                ...
                <div class="mobile-box">
                    ...
                    <div class="show-box">
                        ...
                        <div flex="main:center">
                            <app-image
                                       :src="`statics/img/mall/goods/recommend/style${form.comment_style.list_style}.png`"
                ...
                <div style="width: 100%;">
                    <div style="background: #FFFFFF;padding: 40px 0">
                        ...
                        <el-form-item label="列表样式" prop="list_style">
                            <el-radio v-for="(item, index) in list_style" :key="index"
                                      v-model="form.comment_style.list_style" :label="item.key">{{item.name}}</el-radio>
                        </el-form-item>
                    </div>
                ...
                list_style: [
                    {
                        key: '-1',
                        name: '列表模式',
                        icon: 'statics/img/mall/goods/recommend/style-1.png'
                    },
                    {
                        key: '0',
                        name: '左右滑动',
                        icon: 'statics/img/mall/goods/recommend/style0.png'
                    },
                    {
                        key: '1',
                        name: '一行一个',
                        icon: 'statics/img/mall/goods/recommend/style1.png'
                    },
                    {
                        key: '2',
                        name: '一行两个',
                        icon: 'statics/img/mall/goods/recommend/style2.png'
                    },
                    {
                        key: '3',
                        name: '一行三个',
                        icon: 'statics/img/mall/goods/recommend/style3.png'
                    },
                ]
            }
        },
