...
<!--                         <div flex="cross:center">
                ...
                <div v-if="id == 0 && !newCreate" class="form-body">
                    <div class="title" flex="main:justify cross:center">
                        <span>用户中心列表</span>
                        <el-button type="primary" size="small" @click="$navigate({r: 'mall/user-center/detail'})">新增</el-button>
                    </div>
...
<!--             <el-button v-if="id > 0 || newCreate" class="button-item" :loading="btnLoading" type="primary"
        ...
        <app-setting-index title="设置用户端" :list="platform" :show="indexDialog" :loading="platformLoading" @cancel="cancel"
