    ...
    <el-card class="box-card" shadow="never" style="border:0" body-style="background-color: #f3f3f3;padding: 10px 0 0;"
        ...
        <div class="form-body">
            <el-form :model="ruleForm" :rules="rules" size="small" ref="ruleForm" label-width="150px">
                ...
                <el-form-item v-if="ruleForm.service_type == '微信'" label="物品类目" prop="data.wx_product_type">
                    <el-cascader
                        :options="wx_product_list"
                        v-model="ruleForm.data.wx_product_type">
                    </el-cascader>
                </el-form-item>

                <!-- 顺丰 -->
                <template v-if="ruleForm.distribution_corporation == 1">
                    <el-form-item v-if="ruleForm.service_type == '第三方'" label="物品类目" prop="data.product_type">
                        <el-select v-model="ruleForm.data.product_type" filterable placeholder="请选择">
                            <el-option
                    ...
                    <el-form-item label="Appkey" prop="data.appkey">
                        <el-input v-model="ruleForm.data.appkey" placeholder="请输入appkey"></el-input>
                    </el-form-item>
                    <el-form-item label="AppSecret" prop="data.appsecret">
                        <el-input v-model="ruleForm.data.appsecret" placeholder="请输入appsecret"></el-input>
                    </el-form-item>
                    <el-form-item label="商家门店编号" prop="data.shop_no">
                        <el-input v-model="ruleForm.data.shop_no" placeholder="请输入商家门店编号"></el-input>
                    </el-form-item>
                    <el-form-item label="模拟测试" prop="is_debug">
                        <el-switch
                            v-model="ruleForm.data.is_debug"
                            :active-value="1"
                            :inactive-value="0"
                            active-color="#13ce66"
                ...
                <!-- 闪送 -->
                <template v-if="ruleForm.distribution_corporation == 2">
                    <el-form-item v-if="ruleForm.service_type == '第三方'" label="物品类目" prop="data.product_type">
                        <el-select v-model="ruleForm.data.product_type" filterable placeholder="请选择">
                            <el-option
                                v-for="item in product_list"
                ...
                <template v-if="ruleForm.distribution_corporation == 3">
                    <el-form-item label="配送服务" prop="data.delivery_service_code">
                      <el-select v-model="ruleForm.data.delivery_service_code" filterable placeholder="请选择">
                        <el-option
                    ...
                    <el-form-item prop="data.pay_type_code" label="支付方式">
                        <el-radio v-model="ruleForm.data.pay_type_code" :label="0">账期支付</el-radio>
                        <el-radio v-model="ruleForm.data.pay_type_code" :label="1">余额支付</el-radio>
                    </el-form-item>
                    <el-form-item label="Appkey" prop="data.appkey">
                        <el-input v-model="ruleForm.data.appkey" placeholder="请输入appkey"></el-input>
                    </el-form-item>
                ...
                <!-- 达达 -->
                <template v-if="ruleForm.distribution_corporation == 4">
                    <el-form-item v-if="ruleForm.service_type == '第三方'" label="物品类目" prop="data.product_type">
                        <el-select v-model="ruleForm.data.product_type" filterable placeholder="请选择">
                            <el-option
                                v-for="item in product_list"
                    ...
                    <el-form-item label="商户ID" prop="data.shop_id">
                        <el-input v-model="ruleForm.data.shop_id" placeholder="请输入商户ID"></el-input>
                    </el-form-item>
                    <el-form-item label="Appkey" prop="data.appkey">
                        <el-input v-model="ruleForm.data.appkey" placeholder="请输入appkey"></el-input>
                    </el-form-item>
...
<script>
    const app = new Vue({
        ...
        watch: {
            ruleForm(nVal, oVal) {
                let that = this;
                that.corporation_list.forEach(function(item, index) {
                    console.log(123)
                    if (nVal.distribution_corporation == item.value) {
                        that.product_list = item.goods_type;
                    }
                })
            }
        },
        methods: {
            ...
            getDetail() {
                if (getQuery('id')) {
                    ...
                    this.ruleForm = this.corporation_list[0].default;
                }
            },
            getOption() {
                let self = this;
            ...
            distributionChange(item) {
                if (item.value == this.ruleForm.distribution_corporation) {
                    return;
                }

                this.ruleForm.data = item.default.data;
                this.ruleForm.distribution_corporation = item.value
                this.product_list = item.goods_type;
            },
        },
        mounted: function () {
            this.getOption();
