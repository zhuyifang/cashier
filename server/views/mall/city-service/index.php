            ...
            <el-table v-loading="listLoading" :data="list" border style="width: 100%">
                ...
                <el-table-column label="配送名称" width="120">
                    <template slot-scope="scope">
                        <app-ellipsis :line="2">({{scope.row.data.is_debug ? '测试' : '正式'}}){{scope.row.name}}</app-ellipsis>
                    </template>
                </el-table-column>
                ...
                <el-table-column label="商户ID" prop="data.shop_id" width="80"></el-table-column>
                <el-table-column label="appkey" prop="data.appkey"></el-table-column>
                <el-table-column label="appsecret" prop="data.appsecret"></el-table-column>
                <el-table-column label="商家门店编号" prop="data.shop_no"></el-table-column>
