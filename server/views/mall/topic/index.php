...
<div id="app" v-cloak>
    <el-card v-loading="listLoading" shadow="never" style="border:0"
        ...
        <div slot="header">
            <div flex="dir:left">
                <div flex="cross:center" flex-box="1">专题</div>
                <div flex-box="0">
        ...
        <div class="table-body">
            ...
            <div class="input-item">
                <el-input @keyup.enter.native="search" size="small" placeholder="请输入专题标题名称搜索" v-model="searchData.keyword" clearable @clear="search">
            ...
            <el-table :data="list" border style="width: 100%">
                ...
                <el-table-column label="专题内容" width="400px">
