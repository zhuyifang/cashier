...
EOF;
    ...
    '4.3.7' => function () {
        ...
        INSERT INTO `zjhj_bd_core_plugin` VALUES (16, 'fxhb', '拆红包', '1.0.33', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 'http://auth-zjhejiang-com.oss-cn-hangzhou.aliyuncs.com/uploads/versions/9a7e9bb462ece248a6da22d7a2a39b84.png', '裂变式邀请好友拆“红包”', 4);
	    ...
	    INSERT INTO `zjhj_bd_core_plugin` VALUES (41, 'fission', '红包墙', '1.0.1', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 'http://auth-zjhejiang-com.oss-cn-hangzhou.aliyuncs.com/uploads/versions/9a7e9bb462ece248a6da22d7a2a39b84.png', '红包墙', 100);
	    INSERT INTO `zjhj_bd_core_plugin` VALUES (42, 'url_scheme', '微信链接生成工具', '1.0.1', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 'http://auth-zjhejiang-com.oss-cn-hangzhou.aliyuncs.com/uploads/versions/2ee655a1f7f705776d59354bdae7e461.png', '微信链接生成工具', 100);
	    INSERT INTO `zjhj_bd_core_plugin` VALUES (43, 'ma_ke', '同城速送', '1.0.1', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 'http://auth-zjhejiang-com.oss-cn-hangzhou.aliyuncs.com/uploads/versions/a6c0264443a2bb769e63394fc8cddbea.png', '智慧派单系统，打通同城配送各个环节', 100);
	    INSERT INTO `zjhj_bd_core_plugin` VALUES (44, 'minishop', '交易组件', '1.0.1', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 'http://auth-zjhejiang-com.oss-cn-hangzhou.aliyuncs.com/uploads/versions/e6ac30ca874a0ac27668c201a43b5ac5.png', '对接微信视频号，实现从微信视频号主页、视频号直播，直接跳转商家制作的小程序商城。', 100);
	    INSERT INTO `zjhj_bd_core_plugin` VALUES (45, 'weekly_buy', '周期购', '1.0.1', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 'http://auth-zjhejiang-com.oss-cn-hangzhou.aliyuncs.com/uploads/versions/8afa1042dcf25ba4ddb4b514466ddd3b.png', '周期购是一款可以切入“买家一次付款，商家多次发货”的消费场景的功能', 100);
        INSERT INTO `zjhj_bd_core_plugin` VALUES (46, 'scrm', '企业微信SCRM', '1.0.3', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 'http://auth-zjhejiang-com.oss-cn-hangzhou.aliyuncs.com/uploads/versions/4b7e0648144a1bf055ef8d12ef241126.png', '企业微信SCRM', 100);
	    INSERT INTO `zjhj_bd_core_plugin` VALUES (47, 'form_goods', '定制商品', '1.0.2', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 'http://auth-zjhejiang-com.oss-cn-hangzhou.aliyuncs.com/uploads/versions/26c3426ee285e351010d0a9dc16ad653.png', '定制商品', 100);
	    INSERT INTO `zjhj_bd_core_plugin` VALUES (48, 'customer_service', '企业微信客服', '1.0.2', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 'http://auth-zjhejiang-com.oss-cn-hangzhou.aliyuncs.com/uploads/versions/87c653eb97cdf30c91ecfdda776e6ef8.png', '企业微信客服', 100);
	    INSERT INTO `zjhj_bd_core_plugin` VALUES (49, 'uu', 'UU跑腿', '1.0.1', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 'http://auth-zjhejiang-com.oss-cn-hangzhou.aliyuncs.com/uploads/versions/a3566d6fd262d220e2fcb6ebd6e5ed1a.png', 'UU跑腿', 100);
	    ...
	    INSERT INTO `zjhj_bd_plugin_cat_rel` VALUES (41, 'fission', 'nddsdjdaxzmmeqk4');
	    INSERT INTO `zjhj_bd_plugin_cat_rel` VALUES (42, 'url_scheme', 'kwfhnndnbakznksb');
	    INSERT INTO `zjhj_bd_plugin_cat_rel` VALUES (43, 'ma_ke', 'kwfhnndnbakznksb');
	    INSERT INTO `zjhj_bd_plugin_cat_rel` VALUES (44, 'minishop', 'kwfhnndnbakznksb');
	    INSERT INTO `zjhj_bd_plugin_cat_rel` VALUES (45, 'weekly_buy', 'nddsdjdaxzmmeqk4');
	    INSERT INTO `zjhj_bd_plugin_cat_rel` VALUES (46, 'scrm', '3wsern27hxspzytd');
	    INSERT INTO `zjhj_bd_plugin_cat_rel` VALUES (47, 'form_goods', 'nddsdjdaxzmmeqk4');
	    INSERT INTO `zjhj_bd_plugin_cat_rel` VALUES (48, 'customer_service', '3wsern27hxspzytd');
	    INSERT INTO `zjhj_bd_plugin_cat_rel` VALUES (49, 'uu', 'kwfhnndnbakznksb');
		...
		INSERT INTO `zjhj_bd_cloud_template` VALUES (35, '问卷调查表', '[\"http://auth-zjhejiang-com.oss-cn-hangzhou.aliyuncs.com/uploads/versions/5df4ccf2cd511d1cd4a338a988c4468d.png\"]', '问卷调查表', 0.00, 'diy', '0.01', 'http://auth-zjhejiang-com.oss-cn-hangzhou.aliyuncs.com/uploads/versions/8bf40d84a39b7e6549d5d4dc382ab7b0.zip');
		INSERT INTO `zjhj_bd_cloud_template` VALUES (36, '装修模板', '[\"http://auth-zjhejiang-com.oss-cn-hangzhou.aliyuncs.com/uploads/versions/9e88d27000a62ed4e1898bd851638af4.png\"]', '装修模板', 0.00, 'diy', '0.01', 'http://auth-zjhejiang-com.oss-cn-hangzhou.aliyuncs.com/uploads/versions/39d6914190cba3f5ad9ad73cdef3bf4c.zip');
		INSERT INTO `zjhj_bd_cloud_template` VALUES (37, '酒店预定', '[\"http://auth-zjhejiang-com.oss-cn-hangzhou.aliyuncs.com/uploads/versions/02c1d92ce57349ac916c137612649bd0.png\"]', '酒店预定', 0.00, 'diy', '0.01', 'http://auth-zjhejiang-com.oss-cn-hangzhou.aliyuncs.com/uploads/versions/e69d885044f7f94f4dba6702fc3da731.zip');
		INSERT INTO `zjhj_bd_cloud_template` VALUES (38, '护肤模板', '[\"http://auth-zjhejiang-com.oss-cn-hangzhou.aliyuncs.com/uploads/versions/dd3b8559a9d002a30e3dc725b3b6d4c8.png\"]', '护肤模板', 0.00, 'diy', '0.01', 'http://auth-zjhejiang-com.oss-cn-hangzhou.aliyuncs.com/uploads/versions/eb4c17afd6b7d28fdfeb49d56226d4b8.zip');
		INSERT INTO `zjhj_bd_cloud_template` VALUES (39, '申请信用卡', '[\"http://auth-zjhejiang-com.oss-cn-hangzhou.aliyuncs.com/uploads/versions/ef3458de114298a30d1eb248a176a3a0.png\"]', '申请信用卡', 0.00, 'diy', '0.01', 'http://auth-zjhejiang-com.oss-cn-hangzhou.aliyuncs.com/uploads/versions/05971b3435694a70833406dfc31957d7.zip');
		INSERT INTO `zjhj_bd_cloud_template` VALUES (40, '服装定制', '[\"http://auth-zjhejiang-com.oss-cn-hangzhou.aliyuncs.com/uploads/versions/3d971feed5993872a98f25a75959d5ff.png\"]', '服装定制', 0.00, 'diy', '0.01', 'http://auth-zjhejiang-com.oss-cn-hangzhou.aliyuncs.com/uploads/versions/4a49523314998efcf62cc3f55cbe909c.zip');
		INSERT INTO `zjhj_bd_cloud_template` VALUES (41, '招生表单', '[\"http://auth-zjhejiang-com.oss-cn-hangzhou.aliyuncs.com/uploads/versions/67f423e88c3285864dc6d1d07ca7c380.png\"]', '招生表单', 0.00, 'diy', '0.01', 'http://auth-zjhejiang-com.oss-cn-hangzhou.aliyuncs.com/uploads/versions/c0bfffd7e6b07deea616462e3bf93948.zip');
		INSERT INTO `zjhj_bd_cloud_template` VALUES (42, '大闸蟹', '[\"http://auth-zjhejiang-com.oss-cn-hangzhou.aliyuncs.com/uploads/versions/cc6d45124a6676e510effbeddb3feb27.png\"]', '大闸蟹', 0.00, 'diy', '0.01', 'http://auth-zjhejiang-com.oss-cn-hangzhou.aliyuncs.com/uploads/versions/ec8a8c02f33c4ce856f87fd1208eec37.zip');
		INSERT INTO `zjhj_bd_cloud_template` VALUES (43, '烘焙类', '[\"http://auth-zjhejiang-com.oss-cn-hangzhou.aliyuncs.com/uploads/versions/255810d795eff25a09b846f97f9678ef.png\"]', '烘焙类', 0.00, 'diy', '0.01', 'http://auth-zjhejiang-com.oss-cn-hangzhou.aliyuncs.com/uploads/versions/46d67f3e42f8e7057ec1f26bd9fa74b8.zip');
		INSERT INTO `zjhj_bd_cloud_template` VALUES (44, '生鲜类', '[\"http://auth-zjhejiang-com.oss-cn-hangzhou.aliyuncs.com/uploads/versions/190bcfce1b65e04e7f027b7e596c810a.png\"]', '生鲜类', 0.00, 'diy', '0.01', 'http://auth-zjhejiang-com.oss-cn-hangzhou.aliyuncs.com/uploads/versions/6c1913017f6c09af23591f0308673bff.zip');
		INSERT INTO `zjhj_bd_cloud_template` VALUES (45, '水果类', '[\"http://auth-zjhejiang-com.oss-cn-hangzhou.aliyuncs.com/uploads/versions/c49247043caf5d938d0a4c05eddce501.png\"]', '水果类', 0.00, 'diy', '0.01', 'http://auth-zjhejiang-com.oss-cn-hangzhou.aliyuncs.com/uploads/versions/bada971b7ca40463322a3e247af7865d.zip');
		INSERT INTO `zjhj_bd_cloud_template` VALUES (46, '助农类', '[\"http://auth-zjhejiang-com.oss-cn-hangzhou.aliyuncs.com/uploads/versions/38b50e8648df2300a40da90e58a8c801.png\"]', '助农类', 0.00, 'diy', '0.01', 'http://auth-zjhejiang-com.oss-cn-hangzhou.aliyuncs.com/uploads/versions/bbb83f0d6c3728cbdb2b4e945fc93c60.zip');
EOF;
...
EOF;
    ...
    '4.4.36' => function () {
        $sql = <<<EOF
CREATE TABLE `zjhj_bd_diy_form_list` ( `id` int(11) NOT NULL AUTO_INCREMENT, `mall_id` int(11) NOT NULL, `name` varchar(255) NOT NULL DEFAULT '', `status` tinyint(1) NOT NULL DEFAULT '0' COMMENT '提交周期0--不限制1--每天2--每周3--每月4--每年', `limit` int(11) NOT NULL DEFAULT '0' COMMENT '可提交次数', `tip` varchar(255) NOT NULL DEFAULT '' COMMENT '超出可提交次数提示', `form_data` longtext NOT NULL COMMENT '表单内容', `is_delete` tinyint(1) NOT NULL DEFAULT '0', `created_at` datetime NOT NULL, `updated_at` datetime NOT NULL, `deleted_at` datetime NOT NULL, `is_share` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否开启分销0--关闭 1--开启', PRIMARY KEY (`id`) ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
ALTER TABLE `zjhj_bd_ttapp_config` ADD COLUMN `salt` varchar(255) DEFAULT '' COMMENT 'salt';
ALTER TABLE `zjhj_bd_ttapp_config` ADD COLUMN `token` varchar(255) DEFAULT '' COMMENT '回调token';
ALTER TABLE `zjhj_bd_diy_form` ADD COLUMN `is_old` int(11) DEFAULT 1 COMMENT '是否为旧数据';
ALTER TABLE `zjhj_bd_diy_form` ADD COLUMN `form_list_id` int(11) DEFAULT 0 COMMENT '自定义表单ID';
ALTER TABLE `zjhj_bd_diy_form` ADD COLUMN `form_list_name` varchar(255) DEFAULT '' COMMENT '自定义表单名称';
ALTER TABLE `zjhj_bd_diy_form` ADD COLUMN `order_no` varchar(255) DEFAULT '' COMMENT '订单号';
ALTER TABLE `zjhj_bd_diy_form` ADD COLUMN `is_pay` int(11) DEFAULT 0 COMMENT '是否支付';
ALTER TABLE `zjhj_bd_diy_form` ADD COLUMN `pay_price` decimal(10,2) DEFAULT 0 COMMENT '支付金额';
ALTER TABLE `zjhj_bd_diy_form` ADD COLUMN `pay_time` timestamp DEFAULT '0000-00-00 00:00:00' COMMENT '支付时间';
ALTER TABLE `zjhj_bd_diy_form` ADD COLUMN `extra_attributes` longtext DEFAULT null COMMENT '其它信息';
ALTER TABLE `zjhj_bd_diy_form` ADD COLUMN `reply` varchar(255) DEFAULT '' COMMENT '回复信息';
ALTER TABLE `zjhj_bd_diy_form` ADD COLUMN `reply_time` timestamp DEFAULT '0000-00-00 00:00:00' COMMENT '回复时间';
EOF;
        sql_execute($sql);
    },
    '4.4.40' => function () {
        $sql = <<<EOF
ALTER TABLE `zjhj_bd_minishop_goods` ADD COLUMN `brand_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '2100000000' COMMENT '小商店上商品品牌id', ADD COLUMN `qualification_pics` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '小商店上商品资质图片';
CREATE TABLE `zjhj_bd_minishop_brand` ( `id` int(11) NOT NULL AUTO_INCREMENT, `mall_id` int(11) NOT NULL DEFAULT '0', `brand_id` varchar(255) NOT NULL DEFAULT '', `status` tinyint(1) NOT NULL DEFAULT '0' COMMENT '审核状态 0：审核中，1：审核成功，9：审核拒绝', `license` longtext NOT NULL COMMENT '营业执照', `brand_audit_type` tinyint(1) NOT NULL DEFAULT '1' COMMENT '认证审核类型1--国内品牌申请-R标 2--国内品牌申请-TM标 3--海外品牌申请-R标 4--海外品牌申请-TM标', `trademark_type` varchar(255) NOT NULL DEFAULT '' COMMENT '商标分类1～45', `brand_management_type` tinyint(1) NOT NULL DEFAULT '1' COMMENT '经营类型 1--自有品牌 2--代理品牌 3--无品牌', `commodity_origin_type` tinyint(1) NOT NULL DEFAULT '1' COMMENT '是否进口 1--是 2--否', `brand_wording` varchar(255) NOT NULL DEFAULT '' COMMENT '商标/品牌词', `sale_authorization` longtext COMMENT '销售授权书', `trademark_registration_certificate` longtext COMMENT '商标注册证书', `trademark_registrant` varchar(255) NOT NULL DEFAULT '' COMMENT '商标注册人姓名', `trademark_registrant_nu` varchar(255) NOT NULL DEFAULT '' COMMENT '商标注册号/申请号', `trademark_authorization_period` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT '商标有效期', `trademark_registration_application` longtext COMMENT '商标注册申请受理通知书', `trademark_applicant` varchar(255) NOT NULL DEFAULT '' COMMENT '商标申请人姓名', `trademark_application_time` timestamp NULL DEFAULT '0000-00-00 00:00:00' COMMENT '商标申请时间', `created_at` timestamp NOT NULL, `updated_at` timestamp NULL DEFAULT NULL, `deleted_at` timestamp NULL DEFAULT NULL, `is_delete` tinyint(1) NOT NULL DEFAULT '0', `audit_id` varchar(255) NOT NULL DEFAULT '' COMMENT '审核单id', `reject_reason` varchar(255) DEFAULT '' COMMENT '审核结果', PRIMARY KEY (`id`) ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
CREATE TABLE `zjhj_bd_minishop_cat` ( `id` int(11) NOT NULL AUTO_INCREMENT, `mall_id` int(11) NOT NULL, `third_cat_id` int(11) NOT NULL, `license` longtext NOT NULL, `certificate` longtext NOT NULL, `status` tinyint(1) NOT NULL DEFAULT '0' COMMENT '审核状态, 0：审核中，1：审核成功，9：审核拒绝', `audit_id` varchar(255) NOT NULL DEFAULT '' COMMENT '审核单id', `reject_reason` varchar(255) NOT NULL DEFAULT '' COMMENT '如果审核拒绝，返回拒绝原因', `created_at` timestamp NOT NULL, `updated_at` timestamp NULL DEFAULT NULL, `deleted_at` timestamp NULL DEFAULT NULL, `is_delete` tinyint(1) NOT NULL DEFAULT '0', `third_cat_name` varchar(255) NOT NULL DEFAULT '', PRIMARY KEY (`id`) ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
EOF;
        sql_execute($sql);
    },
    '4.4.41' => function () {
        $sql = <<<EOF
ALTER TABLE `zjhj_bd_minishop_brand` MODIFY COLUMN `trademark_authorization_period` timestamp NULL DEFAULT '0000-00-00 00:00:00' COMMENT '商标有效期';
EOF;
        sql_execute($sql);
    },
    '4.4.47' => function () {
        $sql = <<<EOF
CREATE TABLE `zjhj_bd_mch_tags` (`id` int(11) NOT NULL AUTO_INCREMENT, `mall_id` int(11) DEFAULT NULL, `mch_id` int(11) DEFAULT NULL, `name` varchar(255) NOT NULL, `status` tinyint(1) DEFAULT '0', `sort` int(11) DEFAULT '100' COMMENT '排序', `extra_attributes` text, `is_default` int(11) DEFAULT '0' COMMENT '默认标签', `created_at` timestamp NULL DEFAULT NULL, `updated_at` timestamp NULL DEFAULT NULL, `deleted_at` timestamp NULL DEFAULT NULL, `is_delete` int(11) DEFAULT '0', PRIMARY KEY (`id`) ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
CREATE TABLE `zjhj_bd_mch_weitao` (`id` int(11) NOT NULL AUTO_INCREMENT, `mall_id` int(11) DEFAULT NULL, `mch_id` int(11) DEFAULT '0', `title` varchar(255) DEFAULT NULL COMMENT '标题', `layout_type` tinyint(1) DEFAULT '1' COMMENT '布局类型1.大图2.宫格', `pic_url` text COMMENT '封面图', `abstract` varchar(255) DEFAULT '' COMMENT '摘要', `share_title` varchar(255) DEFAULT '' COMMENT '分享标题', `share_pic_url` varchar(255) DEFAULT '' COMMENT '分享图片', `tag_id` int(11) DEFAULT '0' COMMENT '标签ID', `is_show` tinyint(1) DEFAULT '1' COMMENT '是否显示', `read_number` int(11) DEFAULT NULL COMMENT '阅读量', `virtual_read_number` int(11) DEFAULT '0' COMMENT '虚拟阅读量', `sort` int(11) DEFAULT '100' COMMENT '排序', `add_goods_type` tinyint(1) DEFAULT '1' COMMENT '添加商品类型1.自动添加 2.手动添加', `add_goods_number` int(11) DEFAULT '10' COMMENT '添加商品数量', `add_goods_list` text, `created_at` timestamp NULL DEFAULT NULL, `updated_at` timestamp NULL DEFAULT NULL, `deleted_at` timestamp NULL DEFAULT NULL, `is_delete` tinyint(1) DEFAULT '0', `detail` longtext, PRIMARY KEY (`id`) ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
ALTER TABLE `zjhj_bd_favorite` ADD COLUMN `favorite_mch_id` int(11) DEFAULT 0 COMMENT '商户ID';
ALTER TABLE `zjhj_bd_mch_setting` ADD COLUMN `service_type` tinyint(1) DEFAULT 0 COMMENT '0.关闭 1.客服外链 2.拨打电话';
EOF;
        sql_execute($sql);
    },
    '4.4.48' => function () {
        $sql = <<<EOF
ALTER TABLE `zjhj_bd_order` ADD COLUMN `new_status` int(11) NOT NULL DEFAULT 0 COMMENT '状态字段（转成二进制查看）从右往左查看依次：是否中断交易、是否关闭\n00—未中断交易\n11—中断交易，已关闭\n10—已关闭';
CREATE TABLE `zjhj_bd_weekly_buy_express` ( `id` int(11) NOT NULL AUTO_INCREMENT, `mall_id` int(11) NOT NULL DEFAULT '0', `order_id` int(11) NOT NULL DEFAULT '0', `order_detail_id` int(11) NOT NULL DEFAULT '0', `order_detail_express_id` int(11) NOT NULL DEFAULT '0', `week_number` int(11) NOT NULL DEFAULT '0' COMMENT '第几期', `is_send` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否发货', `is_confirm` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否确认收货', `is_delay` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否延期 0--不延期 1--用户延期 2--商家手动延期 4--未发货自动延期', `send_time` timestamp NULL DEFAULT NULL COMMENT '预约发货时间', `delay_time` timestamp NULL DEFAULT NULL COMMENT '延期时间', `is_delete` tinyint(1) NOT NULL DEFAULT '0', `order_clerk_id` int(11) NOT NULL DEFAULT '0' COMMENT '核销信息表id', `clerk_id` int(11) NOT NULL DEFAULT '0' COMMENT '核销员id', `delay_week_number` int(11) NOT NULL DEFAULT '0' COMMENT '顺延至', `confirm_time` timestamp NULL DEFAULT NULL COMMENT '确认收货时间', `express_content` longtext COMMENT '备注', `updated_at` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP, `created_at` timestamp NULL DEFAULT NULL, `deleted_at` timestamp NULL DEFAULT NULL, PRIMARY KEY (`id`) USING BTREE ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
CREATE TABLE `zjhj_bd_weekly_buy_goods` ( `id` int(11) NOT NULL AUTO_INCREMENT, `mall_id` int(11) NOT NULL DEFAULT '0', `goods_id` int(11) NOT NULL DEFAULT '0', `start_time` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT '开始时间', `end_time` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT '结束时间', `week_type` tinyint(1) NOT NULL DEFAULT '1' COMMENT '配送周期 1--每日一期 2--每周一期 3--每月一期 4--自定义（天/期）', `week_status_day` varchar(255) NOT NULL DEFAULT '' COMMENT '每日一期的配送日期 1--每天配送 2--工作日每日配送 3--周末每天配送 4—隔天配送', `week_status_week` varchar(255) NOT NULL DEFAULT '' COMMENT '每周一期的配送日期 1—周一 2—周二 3—周三 4—周四 5—周五 6—周六 0—周日', `week_status_month` varchar(255) NOT NULL DEFAULT '' COMMENT '每月一期的配送日期 1～31', `week_status_customize` varchar(255) NOT NULL DEFAULT '' COMMENT '自定义的配送日期1～31', `week_status_customize_day` int(11) NOT NULL DEFAULT '1' COMMENT '自定义配送的天数', `before_day` int(11) NOT NULL DEFAULT '0' COMMENT '支付提前的天数', `last_time` int(11) NOT NULL DEFAULT '0' COMMENT '一天的截止时间 0~23', `delay` int(11) NOT NULL DEFAULT '0' COMMENT '顺延提前的天数', `delay_limit_type` tinyint(1) NOT NULL DEFAULT '0' COMMENT '顺延限制类型 0--不限制 1--每个周期购活动，每人每月顺延次数限制', `delay_limit_number` int(11) NOT NULL DEFAULT '1' COMMENT '可顺延次数', `freight_type` tinyint(1) NOT NULL DEFAULT '0' COMMENT '运费类型0--适用商城运费 1--固定运费', `freight` decimal(10,2) NOT NULL DEFAULT '0.00' COMMENT '固定运费（元）', `shipping_type` tinyint(1) NOT NULL COMMENT '包邮类型0--不包邮 1--满期包邮 2--满额包邮', `shipping_number` int(11) NOT NULL DEFAULT '1' COMMENT '包邮的期数', `shipping_price` decimal(10,2) NOT NULL DEFAULT '0.00' COMMENT '包邮的金额（元）', `weekly_buy_goods_id` int(11) NOT NULL DEFAULT '0' COMMENT '主商品id', `created_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00', `updated_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00', `deleted_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00', `is_delete` tinyint(1) NOT NULL DEFAULT '0', `city_freight_type` tinyint(1) NOT NULL DEFAULT '0' COMMENT '同城配送运费类型0--适用商城运费 1--固定运费', `city_freight` decimal(10,2) NOT NULL DEFAULT '0.00' COMMENT '同城配送固定运费（元）', PRIMARY KEY (`id`) ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
CREATE TABLE `zjhj_bd_weekly_buy_groups` ( `id` int(11) NOT NULL AUTO_INCREMENT, `mall_id` int(11) NOT NULL DEFAULT '0', `goods_id` int(11) NOT NULL DEFAULT '0', `weekly_buy_goods_id` int(11) NOT NULL DEFAULT '0', `number` int(11) NOT NULL DEFAULT '0' COMMENT '周期', `is_delete` tinyint(1) NOT NULL DEFAULT '0', PRIMARY KEY (`id`) ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
CREATE TABLE `zjhj_bd_weekly_buy_order_detail` ( `id` int(11) NOT NULL AUTO_INCREMENT, `mall_id` int(11) NOT NULL, `order_id` int(11) NOT NULL, `order_detail_id` int(11) NOT NULL DEFAULT '0', `week_number` int(11) NOT NULL DEFAULT '0' COMMENT '周期数', `num` int(11) NOT NULL DEFAULT '0' COMMENT '商品总数量', `week_key` varchar(255) NOT NULL DEFAULT '' COMMENT '初始配送日期', `actual_week_number` int(11) NOT NULL DEFAULT '0' COMMENT '已配送周期', `sent_num` int(11) NOT NULL DEFAULT '0' COMMENT '已配送数量', `main_goods_id` int(11) NOT NULL DEFAULT '0' COMMENT '主商品id', `main_goods_attr_id` int(11) NOT NULL DEFAULT '0' COMMENT '主商品规格id', PRIMARY KEY (`id`) USING BTREE ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
ALTER TABLE `zjhj_bd_order_refund` ADD COLUMN `reality_refund_express_price` decimal(10, 2) NOT NULL DEFAULT 0 COMMENT '实际退运费';
EOF;
        sql_execute($sql);
    },
    '4.4.49' => function () {
        $sql = <<<EOF
CREATE TABLE `zjhj_bd_ttapp_order` ( `id` int(11) NOT NULL AUTO_INCREMENT, `mall_id` int(11) DEFAULT NULL, `mch_id` int(11) DEFAULT NULL, `order_id` int(11) DEFAULT NULL, `out_settle_no` varchar(255) DEFAULT '', `status` int(11) DEFAULT '0' COMMENT '是否分账', `money` int(11) DEFAULT '0' COMMENT '分账金额（分）', `is_delete` tinyint(1) DEFAULT '0', `created_at` timestamp NULL DEFAULT NULL, `updated_at` timestamp NULL DEFAULT NULL, `deleted_at` timestamp NULL DEFAULT NULL, PRIMARY KEY (`id`) ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
EOF;
        sql_execute($sql);
    },
    '4.4.50' => function () {
        $sql = <<<EOF
ALTER TABLE `zjhj_bd_topic` ADD COLUMN `is_old` tinyint(1) DEFAULT 1 COMMENT '是否为旧数据';
ALTER TABLE `zjhj_bd_topic_type` ADD COLUMN `extra_attributes` text DEFAULT null COMMENT '标签信息';
ALTER TABLE `zjhj_bd_topic` ADD COLUMN `add_goods_type` TINYINT DEFAULT 1 COMMENT '添加商品类型1.自动添加 2.手动添加';
ALTER TABLE `zjhj_bd_topic` ADD COLUMN `add_goods_number` INT DEFAULT 10 COMMENT '添加商品数量';
ALTER TABLE `zjhj_bd_topic` ADD COLUMN `add_goods_list` text DEFAULT null COMMENT '商品列表';
ALTER TABLE `zjhj_bd_topic` ADD COLUMN `read_number` int(11) DEFAULT 0 COMMENT '阅读量';
ALTER TABLE `zjhj_bd_topic` ADD COLUMN `is_show` int(11) DEFAULT 0 COMMENT '是否显示';
ALTER TABLE `zjhj_bd_topic` ADD COLUMN `is_default` int(1) DEFAULT 0 COMMENT '是否默认';
ALTER TABLE `zjhj_bd_diy_form_list` ADD COLUMN `time_status` tinyint(1) DEFAULT 0 COMMENT '定时状态0.关闭|1.开启';
ALTER TABLE `zjhj_bd_diy_form_list` ADD COLUMN `time_at` timestamp NULL COMMENT '定时时间';
ALTER TABLE `zjhj_bd_diy_form` ADD COLUMN `attr_key` varchar(255) DEFAULT '' COMMENT '规格ID';
EOF;
        sql_execute($sql);
    },
    '4.4.51' => function () {
...
EOF;
    ...
    '4.4.53' => function () {
        $sql = <<<EOF
        ALTER TABLE `zjhj_bd_weekly_buy_goods` 
ADD COLUMN `city_shipping_type` tinyint(1) NOT NULL DEFAULT 0 COMMENT '同城配送包邮类型0--不包邮 1--满期包邮 2--满额包邮', 
ADD COLUMN `city_shipping_number` int(11) NOT NULL DEFAULT 1 COMMENT '同城配送包邮的期数', 
ADD COLUMN `city_shipping_price` decimal(10, 2) NOT NULL DEFAULT 0.00 COMMENT '同城配送包邮的金额（元）',
ADD COLUMN `is_no_end_time` tinyint(1) NOT NULL DEFAULT 0 COMMENT '结束时间是否无限制0--不无限1--无限',
ADD COLUMN `week_custom` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '周期选项名称',
MODIFY COLUMN `week_type` tinyint(1) NOT NULL DEFAULT 1 COMMENT '配送周期 1--每日一期 2--每周一期 3--每月一期 4--自定义（天/期）5--按周循环 6--按月循环',
ADD COLUMN `week_mode` tinyint(1) NOT NULL DEFAULT 0 COMMENT '周期方式0--周期模式1--循环模式',
ADD COLUMN `week_loop` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '按周循环的配送日期',
ADD COLUMN `month_loop` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '按月循环的配送日期';
ALTER TABLE `zjhj_bd_weekly_buy_groups` ADD COLUMN `title` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '标题';
ALTER TABLE `zjhj_bd_goods` ADD COLUMN `limit_buy_order` int(11) NOT NULL DEFAULT -1 COMMENT '单笔订单可购买数量';
EOF;
        sql_execute($sql);
    },
    '4.4.59' => function () {
        $sql = <<<EOF
ALTER TABLE `zjhj_bd_user_center` ADD COLUMN `version` int(11) NOT NULL DEFAULT 1 COMMENT '版本', ADD COLUMN `data` longblob NOT NULL COMMENT '版本2的数据';
ALTER TABLE `zjhj_bd_goods_cards` ADD COLUMN `use_type` tinyint(1) DEFAULT 0 COMMENT '是否指定门店使用';
CREATE TABLE `zjhj_bd_goods_card_store_relation` (`id` int(11) NOT NULL AUTO_INCREMENT,`mall_id` int(11) NOT NULL,`mch_id` int(11) DEFAULT '0',`card_id` int(11) NOT NULL COMMENT '商品卡券ID',`store_id` int(11) NOT NULL COMMENT '门店ID',`created_at` timestamp NULL DEFAULT NULL,`updated_at` timestamp NULL DEFAULT NULL,`deleted_at` timestamp NULL DEFAULT NULL,`is_delete` tinyint(1) DEFAULT '0',PRIMARY KEY (`id`)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
EOF;
        sql_execute($sql);
    },
    '4.4.62' => function () {
        $sql = <<<EOF
ALTER TABLE `zjhj_bd_goods_attr` ADD COLUMN `cost_price` decimal(10,2) DEFAULT 0 COMMENT '成本价';
EOF;
        sql_execute($sql);
    },
    '4.4.63' => function () {
        $sql = <<<EOF
ALTER TABLE `zjhj_bd_mch_goods` ADD INDEX `goods_id`(`goods_id`) USING BTREE;
EOF;
        sql_execute($sql);
    },
    '4.4.65' => function () {
...
ALTER TABLE `zjhj_bd_diy_page` ADD COLUMN `is_link` tinyint(1) NOT NULL DEFAULT 0 COMMENT '无权限是否跳转',ADD COLUMN `link` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '无权限跳转的连接';
EOF;
        sql_execute($sql);
    },
    '4.4.66' => function () {
        $sql = <<<EOF
ALTER TABLE `zjhj_bd_user_platform` ADD INDEX `mall_id`(`mall_id`) USING BTREE,ADD INDEX `user_id`(`user_id`) USING BTREE;
EOF;
        sql_execute($sql);
    },
    '4.4.68' => function () {
        $sql = <<<EOF
ALTER TABLE `zjhj_bd_order_detail_express_relation` ADD INDEX `mall_id`(`mall_id`) USING BTREE;
ALTER TABLE `zjhj_bd_order_detail_express_relation` ADD INDEX `is_delete`(`is_delete`) USING BTREE;
ALTER TABLE `zjhj_bd_order_detail_express_relation` ADD INDEX `order_id`(`order_id`) USING BTREE;
ALTER TABLE `zjhj_bd_order_detail_express_relation` ADD INDEX `order_detail_id`(`order_detail_id`) USING BTREE;
EOF;
        sql_execute($sql);
    },
    '4.4.75' => function () {
        $sql = <<<EOF
ALTER TABLE `zjhj_bd_goods` ADD COLUMN `is_shipping` tinyint(1) NOT NULL DEFAULT 1 COMMENT '是否包邮0--不包邮 1--包邮';
ALTER TABLE `zjhj_bd_goods` ADD COLUMN `is_share` tinyint(1) NOT NULL DEFAULT 1 COMMENT '是否允许分销0--不允许 1--允许';
ALTER TABLE `zjhj_bd_share_cash` ADD COLUMN `use_qrcode` tinyint(1) NOT NULL DEFAULT 0 COMMENT '是否使用收款码0--不使用 1--使用' AFTER `content`;
ALTER TABLE `zjhj_bd_finance` ADD COLUMN `use_qrcode` tinyint(1) NOT NULL DEFAULT 0 COMMENT '是否使用收款码0--不使用 1--使用' AFTER `content`;
ALTER TABLE `zjhj_bd_stock_cash` ADD COLUMN `use_qrcode` tinyint(1) NOT NULL DEFAULT 0 COMMENT '是否使用收款码0--不使用 1--使用' AFTER `content`;
ALTER TABLE `zjhj_bd_region_cash` ADD COLUMN `use_qrcode` tinyint(1) NOT NULL DEFAULT 0 COMMENT '是否使用收款码0--不使用 1--使用' AFTER `content`;
ALTER TABLE `zjhj_bd_bonus_cash` ADD COLUMN `use_qrcode` tinyint(1) NOT NULL DEFAULT 0 COMMENT '是否使用收款码0--不使用 1--使用' AFTER `content`;
ALTER TABLE `zjhj_bd_mch_cash` ADD COLUMN `use_qrcode` tinyint(1) NOT NULL DEFAULT 0 COMMENT '是否使用收款码0--不使用 1--使用' AFTER `content`;
ALTER TABLE `zjhj_bd_share_level` ADD COLUMN `new_condition_type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '新版升级条件：1--下线用户数|2--累计佣金|3--已提现佣金|4—累计消费|5—下线分销商人数', ADD COLUMN `condition_user` int(11) NOT NULL DEFAULT 0 COMMENT '下线用户数', ADD COLUMN `condition_total_share_money` decimal(10, 2) NOT NULL DEFAULT 0 COMMENT '累计佣金', ADD COLUMN `condition_cash` decimal(10, 2) NOT NULL DEFAULT 0 COMMENT '已提现佣金', ADD COLUMN `condition_total_consume` decimal(10, 2) NOT NULL DEFAULT 0 COMMENT '累计消费金额', ADD COLUMN `condition_share` int(11) NOT NULL DEFAULT 0 COMMENT '下线分销商数';
EOF;
        sql_execute($sql);
    },
    '4.4.78' => function () {
        $sql = <<<EOF
CREATE TABLE `zjhj_bd_form_goods` ( `id` int(11) NOT NULL AUTO_INCREMENT, `mall_id` int(11) NOT NULL, `mch_id` int(11) NOT NULL DEFAULT '0', `goods_id` int(11) NOT NULL, `calendar_start` timestamp NULL DEFAULT NULL COMMENT '开始时间', `calendar_end` timestamp NULL DEFAULT NULL COMMENT '结束时间', `is_today` varchar(255) DEFAULT '' COMMENT '时间类型none无限制|today当天|after延后天数', `after_day` int(11) DEFAULT '0' COMMENT '推迟预订天数', `is_alone` tinyint(1) DEFAULT '0' COMMENT '天数计算1.单日期|0.时间段', `has_kuatian` tinyint(1) DEFAULT '0' COMMENT '日期选项0.当天|1.跨天', `is_day` int(11) DEFAULT '1' COMMENT '限制天数量状态', `day_max` int(11) DEFAULT '1' COMMENT '限定天数', `place_unit` varchar(255) DEFAULT '' COMMENT '提示单位', `form_mode_type` varchar(255) DEFAULT 'basic' COMMENT '商品规格模式basic传统模式|calendar日历模式', `customization_data` longtext COMMENT '定制模板数据', `customization_status` tinyint(1) DEFAULT '0' COMMENT '定制模板状态0.关闭|1.开启', `date_share_data` longtext COMMENT '商品分销普通设置', PRIMARY KEY (`id`), KEY `mall_id` (`mall_id`,`mch_id`,`goods_id`,`calendar_start`,`calendar_end`) USING BTREE ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
CREATE TABLE `zjhj_bd_form_goods_template` ( `id` int(11) NOT NULL AUTO_INCREMENT, `mall_id` int(11) NOT NULL, `mch_id` int(11) NOT NULL DEFAULT '0', `name` varchar(255) NOT NULL COMMENT '模板名称', `form_data` longtext, `logic_data` text, `created_at` timestamp NULL DEFAULT NULL, `updated_at` timestamp NULL DEFAULT NULL, `deleted_at` timestamp NULL DEFAULT NULL, `is_delete` tinyint(1) DEFAULT '0', `default_version` varchar(255) NOT NULL DEFAULT '' COMMENT '默认模板版本', PRIMARY KEY (`id`) ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
CREATE TABLE `zjhj_bd_form_goods_attr` ( `id` int(11) NOT NULL AUTO_INCREMENT, `goods_id` int(11) NOT NULL COMMENT '商品ID', `attr_id` int(11) NOT NULL COMMENT '商品规格ID', `date` date DEFAULT NULL COMMENT '日期', `stock` int(11) DEFAULT '0' COMMENT '库存', `price` decimal(10,2) DEFAULT '0.00' COMMENT '价格', `member_price` longtext COMMENT '会员价', `share_level_list` longtext COMMENT '分销价', `has_type` text, PRIMARY KEY (`id`), KEY `index` (`goods_id`,`attr_id`,`date`,`price`) USING BTREE ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
ALTER TABLE `zjhj_bd_mch_cash` MODIFY COLUMN `type_data` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '不同提现类型，提交的数据';
EOF;
        sql_execute($sql);
    },
    '4.5.2' => function () {
        $sql = <<<EOF
CREATE TABLE `zjhj_bd_customer_service_qy` ( `id` int(11) NOT NULL AUTO_INCREMENT, `mall_id` int(11) NOT NULL DEFAULT '0', `created_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00', `update_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' ON UPDATE CURRENT_TIMESTAMP, `deleted_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00', `is_delete` tinyint(1) NOT NULL DEFAULT '0', `enterprise_id` varchar(255) NOT NULL DEFAULT '' COMMENT '企业id', `name` varchar(255) NOT NULL DEFAULT '' COMMENT '企业名称', PRIMARY KEY (`id`) ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
CREATE TABLE `zjhj_bd_customer_service_role` ( `id` int(11) NOT NULL AUTO_INCREMENT, `mall_id` int(11) NOT NULL DEFAULT '0', `created_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00', `update_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' ON UPDATE CURRENT_TIMESTAMP, `deleted_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00', `is_delete` tinyint(1) NOT NULL DEFAULT '0', `qy_id` int(11) NOT NULL DEFAULT '0', `name` varchar(255) NOT NULL DEFAULT '', `url` varchar(255) NOT NULL DEFAULT '', PRIMARY KEY (`id`) ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
EOF;
        sql_execute($sql);
    },
    '4.5.4' => function () {
        $sql = <<<EOF
ALTER TABLE `zjhj_bd_topic` ADD COLUMN `proportion`  tinyint(1) NOT NULL DEFAULT 1 COMMENT '图片比例1,1:1|2,3:2|3,2:1' AFTER `type`;
ALTER TABLE `zjhj_bd_mch_weitao` ADD COLUMN `proportion`  tinyint(1) NOT NULL DEFAULT 1 COMMENT '图片比例1,1:1|2,3:2|3,2:1' AFTER `layout_type`;
EOF;
        sql_execute($sql);
    },
    '4.5.5' => function () {
        $sql = <<<EOF
ALTER TABLE `zjhj_bd_share_cash` ADD INDEX `mall_id`(`mall_id`) USING BTREE;
ALTER TABLE `zjhj_bd_share_cash` ADD INDEX `user_id`(`user_id`) USING BTREE;
ALTER TABLE `zjhj_bd_stock_cash` ADD INDEX `mall_id`(`mall_id`) USING BTREE;
ALTER TABLE `zjhj_bd_stock_cash` ADD INDEX `user_id`(`user_id`) USING BTREE;
ALTER TABLE `zjhj_bd_bonus_cash` ADD INDEX `mall_id`(`mall_id`) USING BTREE;
ALTER TABLE `zjhj_bd_bonus_cash` ADD INDEX `user_id`(`user_id`) USING BTREE;
ALTER TABLE `zjhj_bd_region_cash` ADD INDEX `mall_id`(`mall_id`) USING BTREE;
ALTER TABLE `zjhj_bd_region_cash` ADD INDEX `user_id`(`user_id`) USING BTREE;
ALTER TABLE `zjhj_bd_mch_cash` ADD INDEX `mall_id`(`mall_id`) USING BTREE;
ALTER TABLE `zjhj_bd_mch_cash` ADD INDEX `mch_id`(`mch_id`) USING BTREE;
ALTER TABLE `zjhj_bd_finance` ADD INDEX `mall_id`(`mall_id`) USING BTREE;
ALTER TABLE `zjhj_bd_finance` ADD INDEX `user_id`(`user_id`) USING BTREE;
ALTER TABLE `zjhj_bd_ttapp_order` ADD COLUMN `order_type`  varchar(255) NOT NULL DEFAULT 'order' COMMENT 'order订单|balance余额|member会员购买' AFTER `mch_id`;
ALTER TABLE `zjhj_bd_ttapp_order` ADD COLUMN `order_no`  varchar(255) NOT NULL DEFAULT '' COMMENT '订单号' AFTER `order_id`;
ALTER TABLE `zjhj_bd_ttapp_order` ADD COLUMN `extra_attributes` MEDIUMTEXT  COMMENT '分账信息';
ALTER TABLE `zjhj_bd_lottery` ADD COLUMN `is_trigger` tinyint(1) NOT NULL DEFAULT 1 AFTER `deplete_integral_num`, ADD COLUMN `trigger_type` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT "time" AFTER `is_trigger`, ADD COLUMN `people_min_num` int(11) NOT NULL DEFAULT 1 AFTER `trigger_type`;
ALTER TABLE `zjhj_bd_lottery` ADD COLUMN `open_at` timestamp NULL COMMENT '开奖时间';
ALTER TABLE `zjhj_bd_home_nav` ADD COLUMN `link` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '链接详情';
ALTER TABLE `zjhj_bd_banner` ADD COLUMN `link` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '链接详情';
ALTER TABLE `zjhj_bd_goods_cats` ADD COLUMN `link` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '链接详情';
EOF;
