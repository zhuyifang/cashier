 ...
 * @property string $reality_refund_express_price 实际退运费
 ...
 * @property string $refundGoodsPrice
 */
class OrderRefund extends ModelActiveRecord
{
    ...
    {
        return [
            [['mall_id', 'user_id', 'order_id', 'order_detail_id', 'type', 'pic_list'
                , 'created_at', 'updated_at', 'deleted_at', 'refund_data'], 'required'],
            [['mall_id', 'mch_id', 'user_id', 'order_id', 'order_detail_id', 'type', 'status',
                'is_send', 'address_id', 'is_confirm', 'is_refund', 'is_delete'], 'integer'],
            [['refund_price', 'reality_refund_price', 'reality_refund_express_price'], 'number'],
            [['pic_list', 'refund_data'], 'string'],
            [['status_time', 'send_time', 'confirm_time', 'refund_time', 'created_at', 'updated_at', 'deleted_at'], 'safe'],
            [['order_no', 'remark', 'merchant_remark', 'express_no', 'merchant_express_no', 'merchant_express_content'
    ...
    public function attributeLabels()
    {
        return [
            ...
            'is_delete' => 'Is Delete',
            'reality_refund_express_price' => '实际退运费',
        ];
    }
    ...
    public function getRefundGoodsPrice()
    {
        return price_format($this->reality_refund_price - $this->reality_refund_express_price);
    }
}
