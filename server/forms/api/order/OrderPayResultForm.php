    ...
    public function getResponseData()
    {
        ...
        try {
            ...
            if (\Yii::$app->user->identity->identity->is_distributor != 1 && $isShareTip == 1) {
                ...
                $becomeCondition = $shareApplyForm->getBecomeCondition();
            }
        } catch (\Exception $exception) {
        }

        $rubik = null;
        if (isset($data['rubik_data']) && $data['rubik_data']) {
            $commonPageTwo = CommonPageTwo::getCommon(\Yii::$app->mall);
            $extra = $commonPageTwo->getPage(null, null, json_encode([
                [
                    'id' => 'rubik',
                    'data' => $data['rubik_data']
                ]
            ]));
        ...
        return [
            ...
            'data' => [
                ...
                'pay_send_data' => isset($data['pay_send_data']) ? $data['pay_send_data'] : null,
                'rubik_data' => $rubik,
                'becomeCondition' => $becomeCondition
            ],
        ];
    }
