...
class OrderForm extends Model
{
    ...
    {
        return [
            [['page', 'limit', 'status', 'id', 'express_id', 'order_detail_id'], 'integer'],
    ...
    public function getList()
    {
        ...
        foreach ($list as $item) {
            ...
            $newItem = array_merge($newItem, CommonCustomization::getCommon()->getBtnName($item->detail));
    ...
    public function getCustomization()
    {
        try {
            ...
            foreach ($data as $key => $value) {
                ...
                if ($key == 'customization_name') {
                    unset($data[$key]);
                    $data['form_list_name'] = $value;
                }
            }
