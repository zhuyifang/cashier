...
class ActivityForm extends Model
{
    ...
    public function getDetail()
    {
        try {
            ...
            $newDetail['discount_rule'] = \Yii::$app->serializer->decode($detail->discount_rule);
            $newDetail['loop_discount_rule'] = Json::decode($detail->loop_discount_rule, true);
            if (empty($newDetail['loop_discount_rule'])) {
                $newDetail['loop_discount_rule'] = [
                    'cut' => '',
                    'min_money' => ''
                ];
            }
