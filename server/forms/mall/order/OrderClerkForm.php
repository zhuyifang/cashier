...
class OrderClerkForm extends Model
{
    ...
    public function affirmPay()
    {
        try {
            ...
            $commonOrderClerk->plugin = $this->plugin;
            $commonOrderClerk->affirmPay();
    ...
    {
        try {
            $commonOrderClerk = $this->getClerkClass();
            $commonOrderClerk->id = $this->order_id;
            $commonOrderClerk->action_type = $this->action_type;
    ...
    public function getClerkClass()
    {
        try {
            $commonOrderClerk = \Yii::$app->plugin->getPlugin($this->plugin)->getClerkClass();
        } catch (ClassNotFoundException $exception) {
            $commonOrderClerk = new CommonOrderClerk();
        }
        return $commonOrderClerk;
    }
}
