...
abstract class BaseOrderForm extends Model
{
    ...
    {
        return [
            [['order_id', 'is_mch', 'mch_id', 'order_detail_id'], 'integer'],
            ...
            ['type', 'in', 'range' => ['', 'goods', 'ecard', 'form-goods']],
        ];
    }
    ...
    public function search()
    {
        ...
        foreach ($list as &$item) {
            ...
            $item = array_merge($item, CommonCustomization::getCommon()->getBtnName($item['detail']));
            $item['customization_status'] = CommonCustomization::getCommon()->getIsCustomization($item['detail']);
        }
    ...
    protected function where()
    {
        ...
        $query->keyword($this->status == -1, ['AND', ['o.is_recycle' => 0]])
            ...
            ->keyword($this->status == 3, [
                'AND',
                ['or', ['o.is_send' => 1, 'o.is_confirm' => 1, 'o.is_sale' => 1], 'o.new_status & 2'],
                ['or', ['o.is_pay' => 1], ['o.pay_type' => 2]],
                ['not', ['o.cancel_status' => 1]],
                ['o.is_recycle' => 0]
            ])
    ...
    public function orderCustomization()
    {
        ...
        try {
            $data = CommonCustomization::getCommon()->getOrerCustomization($this->order_detail_id);
            return [
                'code' => ApiCode::CODE_SUCCESS,
                'msg' => '请求成功',
                'data' => $data
