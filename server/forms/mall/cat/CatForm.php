...
class CatForm extends Model
{
            ...
            foreach ($list as $item) {
                ...
                if (isset($item->child) && count($item->child)) {
                    ...
                    foreach ($item->child as $children) {
                        ...
                        $newChildren['mch_id'] = $children->mch_id;
                        if (isset($children->child) && count($children->child)) {
                            foreach ($children->child as $third) {
    ...
    public function getDetail()
    {
        ...
        try {
            ...
            $newDetail['link'] = $detail['link'] ? Json::decode($detail['link']) : null;
            return [
                'code' => ApiCode::CODE_SUCCESS,
                'msg' => '请求成功',
                'data' => [
