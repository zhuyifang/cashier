...
class OtherCitySendForm extends BaseSend
{
    ...
    public function saveExtraData($orderDetailExpress)
    {
        ...
        } else if($this->cityServiceForm->getModel()->getDivers() == 'uu') {
            $orderDetailExpress->shop_order_id = $res['ordercode'];
        } else {
    ...
    private function getOrderInfo()
    {
        ...
        if (isset($cityServiceData['wx_product_type'])) {
            $wxProductType = $cityServiceData['wx_product_type'];
        ...
        $data = [
            ...
            "receiver" => [
                ...
                "city" => $this->cityServiceForm->getAddressInfo(isset($location[0]) ? $location[0] : 0, isset($location[1]) ? $location[1] : 0, 'receiver')['city'],
            ...
            "sender" => [
                ...
                "city" => $this->cityServiceForm->getAddressInfo($delivery['address']['longitude'], $delivery['address']['latitude'], 'sender')['city'],
