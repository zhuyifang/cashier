...
class CommonFormat
{
    ...
    {
        $path = PluginHelper::getPluginBaseAssetsUrl();
        return [
            'select_style' => '1',
            'sub_title' => '有专属福利优惠活动哦~',
            'sub_title_color' => '#999999',
            'two_icon' => $path . '/images/icon-customer-two.png',
            'two_radius' => 40,
            'two_title' => '复制微信号',
            'two_bg' => '#ff4544',
            'two_border' => '#FFFFFF',
    ...
    public function timer()
    {
        ...
        return [
            ...
            'bg_color' => '#FFFFFF',
            'bgPicUrl' => $mallUrl . '/timer-bottom-bg.png',
        ];
    }
