		...
		<view v-if="!getSuccess">
			...
			<view class="get-dialog main-center cross-center" v-if="getView">
				<view class="get-item" @click="toGet">
					<image @click="getView = false" class="close-btn" src="/static/image/icon/invalid.png"></image>
			...
			<view class="get-dialog main-center cross-center" v-if="shareView">
				<view class="get-item">
					<image @click="shareView = false" class="close-btn" src="/static/image/icon/invalid.png"></image>
